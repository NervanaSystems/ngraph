...
#include "ngraph/pass/constant_propagation.hpp"
...
TEST(constant_propagation, constant_reshape)
{
    Shape shape_in{2, 4};
    ...
    pass_manager.register_pass<pass::ConstantPropagation>();
...
TEST(constant_propagation, constant_reshape_permute)
{
    Shape shape_in{2, 4};
    Shape shape_out{4, 2};
