    ...
    for (auto type : types)
    {
        for (auto shape : shapes)
        {
            ...
            auto add_a_0 = make_shared<op::Abs>(
                make_shared<op::v0::Add>(a, iconst0, op::AutoBroadcastType::NUMPY));
            auto add_a_0_0 =
                make_shared<op::v0::Add>(add_a_0, iconst0, op::AutoBroadcastType::NUMPY);
            auto add_b_0 = make_shared<op::Abs>(
                make_shared<op::v0::Add>(b, iconst0, op::AutoBroadcastType::NUMPY));
            auto add_b_0_0 =
                make_shared<op::v0::Add>(add_b_0, iconst0, op::AutoBroadcastType::NUMPY);

            auto f = std::make_shared<Function>(ngraph::OutputVector{a, b, add_a_0_0, c, add_b_0_0},
                                                ParameterVector{a, b, c});
            pass_manager.run_passes(f);

            ASSERT_EQ(count_ops_of_type<op::v0::Add>(f), 0);
            auto expected = ngraph::NodeVector{a, b, a, c, b};
            auto results = f->get_results();
            for (size_t i = 0; i < results.size(); i++)
            {
...
TEST(algebraic_simplification, add_v1_broadcast_v1)
{
    ...
    auto add_a_0 = make_shared<op::Abs>(
        make_shared<op::v0::Add>(a, const_broadcast, op::AutoBroadcastType::NUMPY));
    auto add_a_0_0 =
        make_shared<op::v0::Add>(add_a_0, const_broadcast, op::AutoBroadcastType::NUMPY);
    auto add_b_0 = make_shared<op::Abs>(
        make_shared<op::v0::Add>(b, const_broadcast, op::AutoBroadcastType::NUMPY));
    auto add_b_0_0 =
        make_shared<op::v0::Add>(add_b_0, const_broadcast, op::AutoBroadcastType::NUMPY);
...
TEST(algebraic_simplification, zero_plus_zero_commutativity_v1)
{
    ...
    auto iconst0 = ngraph::make_constant_from_string("0", type, shape);
    auto add_a_0 = make_shared<op::Abs>(
        make_shared<op::v0::Add>(iconst0, iconst0, op::AutoBroadcastType::NUMPY));
    auto add_a_0_0 = make_shared<op::Abs>(
        make_shared<op::v0::Add>(iconst0, iconst0, op::AutoBroadcastType::NUMPY));
    auto add_b_0 =
        make_shared<op::Abs>(make_shared<op::v0::Add>(iconst0, b, op::AutoBroadcastType::NUMPY));
    auto add_b_0_0 =
        make_shared<op::Abs>(make_shared<op::v0::Add>(iconst0, b, op::AutoBroadcastType::NUMPY));
...
TEST(algebraic_simplification, add_negative_tests_v1)
{
    ...
    auto abs_a = make_shared<op::Abs>(a);
    auto iconst2 = ngraph::make_constant_from_string("2", type, shape);
    auto add_a_0 = make_shared<op::v0::Add>(a, iconst2, op::AutoBroadcastType::NUMPY);
    auto add_a_0_0 = make_shared<op::v0::Add>(add_a_0, iconst2, op::AutoBroadcastType::NUMPY);
    auto add_b_0 = make_shared<op::v0::Add>(b, abs_a, op::AutoBroadcastType::NUMPY);
    auto add_b_0_0 = make_shared<op::v0::Add>(add_b_0, abs_a, op::AutoBroadcastType::NUMPY);
