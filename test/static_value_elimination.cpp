...
TEST(static_value_elimination, eliminate_convert)
{
    ...
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    auto f = make_shared<Function>(
        make_shared<op::Convert>(make_shared<op::GetShape>(A),element::f32),
        op::ParameterVector{A});
...
TEST(static_value_elimination, eliminate_dyn_reshape)
{
    ...
    auto f = make_shared<Function>(
        make_shared<op::DynReshape>(make_shared<op::GetShape>(A), K),
        op::ParameterVector{A});
...
TEST(static_value_elimination, eliminate_concat)
{
    ...
    auto f = make_shared<Function>(
        make_shared<op::Concat>(NodeVector{make_shared<op::GetShape>(A), make_shared<op::GetShape>(B)}, 0),
...
TEST(static_value_elimination, eliminate_multiply)
{
    ...
    auto f = make_shared<Function>(
        make_shared<op::Multiply>(make_shared<op::GetShape>(A), K),
        op::ParameterVector{A});
...
TEST(static_value_elimination, eliminate_divide)
{
    ...
    auto f = make_shared<Function>(
        make_shared<op::Divide>(make_shared<op::GetShape>(A), K),
        op::ParameterVector{A});
