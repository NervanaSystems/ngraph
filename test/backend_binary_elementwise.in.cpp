...
NGRAPH_TEST(${BACKEND_NAME}, dot_add_2_subgraphs)
{
    Shape shape_in1{2, 3};
    Shape shape_in2{3, 3};
    Shape shape_out{2, 3};
    ...
    auto P3 = make_shared<op::Parameter>(element::f32, shape_out);
    ...
    shared_ptr<runtime::Tensor> p3 = backend->create_tensor(element::f32, shape_out);
    ...
    shared_ptr<runtime::Tensor> p6 = backend->create_tensor(element::f32, shape_out);
    shared_ptr<runtime::Tensor> result = backend->create_tensor(element::f32, shape_out);
...
NGRAPH_TEST(${BACKEND_NAME}, dot_add_2_subgraphs_2)
{
