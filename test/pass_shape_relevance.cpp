...
TEST(shape_relevance, param_direct)
{
    ...
    auto x = make_shared<op::v1::Reshape>(param0, param1);
...
TEST(shape_relevance, param_indirect)
{
    ...
    auto x = make_shared<op::v1::Reshape>(param0, c);
...
TEST(shape_relevance, param_shape_of_direct)
{
    ...
    auto x = make_shared<op::v1::Reshape>(param0, make_shared<op::ShapeOf>(param0));
...
TEST(shape_relevance, param_shape_of_indirect)
{
    ...
    auto x = make_shared<op::v1::Reshape>(param0, r);
