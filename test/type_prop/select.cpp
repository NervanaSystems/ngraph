...
TEST(type_prop, select_deduce)
{
    ...
    auto tv0_2_4_param_2 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4});
    auto bc = make_shared<op::v0::Select>(tv0_2_4_param_0, tv0_2_4_param_1, tv0_2_4_param_2);
...
{
    auto tv0_2_4_param_0 = make_shared<op::v0::Parameter>(element::boolean, Shape{3, 5});
    auto tv0_2_4_param_1 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4});
    auto tv0_2_4_param_2 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4});
    try
    {
...
{
    auto tv0_2_4_param_0 = make_shared<op::v0::Parameter>(element::boolean, Shape{2, 4});
    auto tv0_2_4_param_1 = make_shared<op::v0::Parameter>(element::f32, Shape{3, 5});
    auto tv0_2_4_param_2 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4});
    try
    {
        auto bc = make_shared<op::v0::Select>(tv0_2_4_param_0, tv0_2_4_param_1, tv0_2_4_param_2);
...
TEST(type_prop, select_shape_mismatch_c)
{
    auto tv0_2_4_param_0 = make_shared<op::v0::Parameter>(element::boolean, Shape{2, 4});
    auto tv0_2_4_param_1 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4});
    auto tv0_2_4_param_2 = make_shared<op::v0::Parameter>(element::f32, Shape{3, 5});
    try
    {
        auto bc = make_shared<op::v0::Select>(tv0_2_4_param_0, tv0_2_4_param_1, tv0_2_4_param_2);
        // Should have thrown, so fail if it didn't
...
{
    auto param0 = make_shared<op::v0::Parameter>(element::boolean, PartialShape::dynamic());
    ...
    auto sel = make_shared<op::v0::Select>(param0, param1, param2);
...
TEST(type_prop, select_partial_all_rank_dynamic_arg0_et_dynamic_arg1_arg2_et_mismatch)
{
    ...
    auto param1 = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
    auto param2 = make_shared<op::v0::Parameter>(element::i32, PartialShape::dynamic());
...
TEST(type_prop, select_partial_all_rank_dynamic_arg0_arg2_et_dynamic)
{
    auto param0 = make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
    auto param1 = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
    auto param2 = make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
...
{
    auto param0 =
        make_shared<op::v0::Parameter>(element::boolean, PartialShape{2, Dimension::dynamic(), 3});
    auto param1 = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
    auto param2 = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
...
TEST(type_prop, select_partial_all_rank_static_intransitive_incompatibility)
{
    ...
    auto param1 = make_shared<op::v0::Parameter>(
        element::f32, PartialShape{Dimension::dynamic(), 8, Dimension::dynamic()});
    auto param2 =
        make_shared<op::v0::Parameter>(element::f32, PartialShape{3, Dimension::dynamic(), 3});
...
{
    auto tp = GetParam();
    auto cond = make_shared<op::v0::Parameter>(tp.ets[0], tp.shapes[0]);
    auto ptrue = make_shared<op::v0::Parameter>(tp.ets[1], tp.shapes[1]);
    auto pfalse = make_shared<op::v0::Parameter>(tp.ets[2], tp.shapes[2]);
...
{
    auto a = make_shared<op::v0::Parameter>(element::boolean, PartialShape::dynamic());
    auto b = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4});
...
{
    auto a = make_shared<op::v0::Parameter>(element::boolean, PartialShape{Dimension::dynamic()});
    auto b = make_shared<op::v0::Parameter>(element::f32, PartialShape{Dimension::dynamic()});
    auto c = make_shared<op::v0::Parameter>(element::f32, PartialShape{2, Dimension::dynamic()});
...
{
    auto param0 = make_shared<op::v0::Parameter>(element::i8, Shape{2, 4});
    auto param1 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4});
    auto param2 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4});
...
{
    auto param0 = make_shared<op::v0::Parameter>(element::boolean, Shape{2, 4});
    auto param1 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4});
    auto param2 = make_shared<op::v0::Parameter>(element::i8, Shape{2, 4});
...
{
    auto param0 = make_shared<op::v0::Parameter>(element::boolean, Shape{2, 4});
    auto param1 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 3});
    auto param2 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4});
...
{
    auto param0 =
        make_shared<op::v0::Parameter>(element::boolean, PartialShape{3, Dimension::dynamic()});
    auto param1 =
        make_shared<op::v0::Parameter>(element::f32, PartialShape{2, Dimension::dynamic()});
    auto param2 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4});
