...
TEST(type_prop, ess)
{
    ...
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
...
{
    auto emb_table =
        make_shared<op::v0::Parameter>(element::f32, PartialShape{5, Dimension::dynamic()});
    auto indices = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto segment_ids = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
...
{
    auto emb_table = make_shared<op::v0::Parameter>(element::f32, Shape{5, 2});
    auto indices = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto segment_ids = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{});
...
TEST(type_prop, ess_fail_segment_ids_element_type)
{
    auto emb_table = make_shared<op::v0::Parameter>(element::f32, Shape{5, 2});
    auto indices = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto segment_ids = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{});
...
TEST(type_prop, ess_fail_number_segments_element_type)
{
    ...
    auto indices = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto segment_ids = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto num_segments = make_shared<op::v0::Parameter>(element::f32, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{});
...
TEST(type_prop, ess_fail_default_index_element_type)
{
    ...
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::f32, Shape{});
...
{
    auto emb_table = make_shared<op::v0::Parameter>(element::f32, Shape{5, 2});
    auto indices = make_shared<op::v0::Parameter>(element::i32, Shape{4});
    auto segment_ids = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{});
...
TEST(type_prop, ess_fail_mismatch_element_type_1)
{
    ...
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::i32, Shape{});
...
TEST(type_prop, ess_fail_mismatch_element_type_2)
{
    ...
    auto segment_ids = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{});
...
TEST(type_prop, ess_fail_mismatch_element_type_3)
{
    ...
    auto indices = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto segment_ids = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto num_segments = make_shared<op::v0::Parameter>(element::i32, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{});
...
TEST(type_prop, ess_fail_mismatch_shape)
{
    ...
    auto segment_ids = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{3});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{});
...
TEST(type_prop, ess_fail_num_segments_scalar)
{
    ...
    auto indices = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto segment_ids = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{2});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{});
...
TEST(type_prop, ess_fail_default_index_scalar)
{
    ...
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{2});
...
{
    auto emb_table = make_shared<op::v0::Parameter>(element::f32, Shape{5, 2});
    auto indices = make_shared<op::v0::Parameter>(element::i64, Shape{4, 2});
    auto segment_ids = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{});
...
TEST(type_prop, ess_fail_segment_ids_1d)
{
    auto emb_table = make_shared<op::v0::Parameter>(element::f32, Shape{5, 2});
    auto indices = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto segment_ids = make_shared<op::v0::Parameter>(element::i64, Shape{3, 2});
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{});
...
TEST(type_prop, ess_fail_per_sample_weights_1d)
{
    ...
    auto segment_ids = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto num_segments = make_shared<op::v0::Parameter>(element::i64, Shape{});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4, 2});
    auto default_index = make_shared<op::v0::Parameter>(element::i64, Shape{});
