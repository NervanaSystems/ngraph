...
TEST(type_prop, strided_slice_begin_incorrect_type)
{
    ...
    auto begin = make_shared<op::v0::Parameter>(element::f16, Shape{4});
...
TEST(type_prop, strided_slice_end_incorrect_type)
{
    ...
    auto end = make_shared<op::v0::Parameter>(element::boolean, Shape{4});
    try
    {
        auto strided_slice = make_shared<op::v1::StridedSlice>(
            data, begin, end, vector<int64_t>{1, 0, 1, 0}, vector<int64_t>{1, 0, 1, 0});
...
{
    auto data = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4, 6, 8});
    auto begin = make_shared<op::v0::Parameter>(element::i64, Shape{4, 5});
    auto end = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    try
    {
        auto strided_slice = make_shared<op::v1::StridedSlice>(
...
TEST(type_prop, strided_slice_end_incorrect_shape)
{
    auto data = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4, 6, 8});
    auto begin = make_shared<op::v0::Parameter>(element::i64, Shape{4});
    auto end = make_shared<op::v0::Parameter>(element::i64, Shape{4, 5});
    try
    {
        auto strided_slice = make_shared<op::v1::StridedSlice>(
            data, begin, end, vector<int64_t>{1, 0, 1, 0}, vector<int64_t>{1, 0, 1, 0});
...
{
    auto data = make_shared<op::v0::Parameter>(element::f32, Shape{2, 4, 6, 8});
    auto begin = make_shared<op::v0::Parameter>(element::i64, PartialShape::dynamic());
    auto end = make_shared<op::v0::Parameter>(element::i64, Shape{2});
    auto strided_slice = make_shared<op::v1::StridedSlice>(
    ...
    try
    {
        end = make_shared<op::v0::Parameter>(element::i64, PartialShape::dynamic());
