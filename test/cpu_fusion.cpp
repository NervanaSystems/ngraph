...
TEST(cpu_fusion, rnn_fprop_1_lstm_cell)
{
    ...
    auto weights_layer = make_shared<op::Parameter>(element::f32, Shape{50, 400});
    ...
    shared_ptr<runtime::TensorView> result_ht =
        backend->create_tensor(element::f32, src_layer->get_shape());
    shared_ptr<runtime::TensorView> result_ct = backend->create_tensor(element::f32, Shape{20, 50});
    ...
    vector<float> expected_ht{
        0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f,
        0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f,
        0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f,
        0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f,
        0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f,
        ...
        0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f,
        0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f,
        0.964028f, 0.964028f, 0.964028f, 0.964028f};
    ...
    vector<float> expected_ct{
        ...
        0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f,
        0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f, 0.964028f,
        0.964028f, 0.964028f, 0.964028f, 0.964028f, 2.0f,      2.0f,      2.0f,      2.0f,
...
TEST(cpu_fusion, rnn_fprop_1)
{
    auto src_layer = make_shared<op::Parameter>(element::f32, Shape{30, 50});
    auto src_iter = make_shared<op::Parameter>(element::f32, Shape{20, 50});
    auto weights_layer = make_shared<op::Parameter>(element::f32, Shape{50, 150});
    auto weights_iter = make_shared<op::Parameter>(element::f32, Shape{50, 150});
    auto biases = make_shared<op::Parameter>(element::f32, Shape{150});
    ...
    copy_data(weights_layer_t, vector<float>(7500, 1));
    copy_data(weights_iter_t, vector<float>(5700, 1));
    copy_data(biases_t, vector<float>(150, 1));
    ...
    //vector<float> expected{0.73105858f, 0.98201379f, 0.73105858f, 0.98201379f};
    //ASSERT_TRUE(read_vector<float>(result) == expected);
    auto result_t = read_vector<float>(result_ht);
    std::cout << "result_ht_size: " << result_t.size() << std::endl;
    for (auto& val : result_t)
    {
        std::cout << val << " ";
    }

    result_t = read_vector<float>(result_ct);
    std::cout << "result_ct_size: " << result_t.size() << std::endl;
    for (auto& val : result_t)
    {
        std::cout << val << " ";
    }
