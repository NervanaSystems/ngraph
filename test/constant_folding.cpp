...
TEST(constant_folding, acosh)
{
    ...
    auto new_const = as_type_ptr<op::Constant>(f->get_results()[0]->get_input_node_shared_ptr(0));
...
TEST(constant_folding, shape_of_dynamic_v0)
{
    ...
    auto result_as_concat =
        as_type_ptr<op::Concat>(f->get_results().at(0)->get_input_node_shared_ptr(0));
...
TEST(constant_folding, constant_v1_split)
{
    ...
    auto res1 = as_type_ptr<op::Constant>(f->get_results().at(0)->get_input_node_shared_ptr(0));
    auto res2 = as_type_ptr<op::Constant>(f->get_results().at(1)->get_input_node_shared_ptr(0));
    auto res3 = as_type_ptr<op::Constant>(f->get_results().at(2)->get_input_node_shared_ptr(0));
    ASSERT_TRUE(res1);
    ASSERT_TRUE(res2);
    ASSERT_TRUE(res3);
...
TEST(constant_folding, constant_v1_split_axis_1_4_splits)
{
    ...
    auto res2 = as_type_ptr<op::Constant>(f->get_results().at(1)->get_input_node_shared_ptr(0));
    auto res3 = as_type_ptr<op::Constant>(f->get_results().at(2)->get_input_node_shared_ptr(0));
    auto res4 = as_type_ptr<op::Constant>(f->get_results().at(3)->get_input_node_shared_ptr(0));
    ASSERT_TRUE(res1);
    ASSERT_TRUE(res2);
    ASSERT_TRUE(res3);
    ASSERT_TRUE(res4);
...
TEST(constant_folding, constant_v1_one_hot)
{
    ...
    auto res = as_type_ptr<op::Constant>(f->get_results().at(0)->get_input_node_shared_ptr(0));
    ASSERT_TRUE(res);
