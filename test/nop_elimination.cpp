...
TEST(nop_elimination, unsqueeze_squeeze_overlap_elimination)
{
    ...
    check_usecase(PartialShape{2, 1, 1, 4}, {1, 2}, {4}, 1, 1);
    check_usecase(PartialShape{2, 3, 4}, {1, 2}, {2}, 1, 1);
    check_usecase(PartialShape{2, 3, 1, Dimension::dynamic()}, {1, 2}, {2}, 1, 1);
    check_usecase(PartialShape{2, 3, 1, 4}, {1, 3}, {3}, 1, 1);
