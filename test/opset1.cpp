...
#define CHECK_OPSET(op1, op2) EXPECT_TRUE(is_type<op1>(make_shared<op2>()));
...
TEST(opset, check_opset1)
{
    ...
    CHECK_OPSET(op::v0::Greater, opset1::Greater);
    CHECK_OPSET(op::v0::GreaterEq, opset1::GreaterEq);
    CHECK_OPSET(op::v0::GRN, opset1::GRN);
    CHECK_OPSET(op::v0::GroupConvolution, opset1::GroupConvolution);
    CHECK_OPSET(op::v0::GroupConvolutionTranspose, opset1::GroupConvolutionTranspose);
    ...
    CHECK_OPSET(op::v0::Less, opset1::Less);
    CHECK_OPSET(op::v0::LessEq, opset1::LessEq);
    ...
    CHECK_OPSET(op::v0::Maximum, opset1::Maximum);
    ...
    CHECK_OPSET(op::v0::Power, opset1::Power);
    ...
    CHECK_OPSET(op::v0::Reverse, opset1::Reverse);
