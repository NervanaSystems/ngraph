...
public:
    ...
    bool call<true>(const shared_ptr<Function>& func,
              ...
              const vector<shared_ptr<runtime::TensorView>>& inputs)
    {
        ...
        for (shared_ptr<Function>& sub_function : instance.m_sub_functions)
        {
            ...
            // Call
            backend->call<true>(sub_function, result_tvs, parameter_tvs);
        }
        return rc;
    }
...
TEST(graph_partition, hybrid_abc_manual)
{
    ...
    int_backend->call<true>(f0, {r0, r1}, {a, b, c});
    ...
    cpu_backend->call<true>(f1, {r2}, {p0, p1});
