...
//       CHECK: %[[GA0:.*]] = llvm.mlir.addressof @{{[a-zA-Z_][a-zA-Z0-9_]*}} : !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">
//       CHECK: %[[C0:.*]] = constant {{[0-9]+}} : i64
//       CHECK: %[[MC0:.*]] = memref_cast %arg0 : memref<1x1x3x3xf32> to memref<*xf32>
//       CHECK: %[[MC1:.*]] = memref_cast %arg1 : memref<1x1x3x3xf32> to memref<*xf32>
//       CHECK: %[[MC2:.*]] = memref_cast %arg2 : memref<1xf32> to memref<*xf32>
//       CHECK: %[[MC3:.*]] = memref_cast %arg3 : memref<1x1x1x1xf32> to memref<*xf32>
//       CHECK: call @__mlir_callback_3_inputs(%[[MC0]], %[[MC1]], %[[MC2]], %[[MC3]], %[[GA0]], %[[C0]]) : (memref<*xf32>, memref<*xf32>, memref<*xf32>, memref<*xf32>, !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">, i64) -> ()
...
//       CHECK: %[[GA0:.*]] = llvm.mlir.addressof @{{[a-zA-Z_][a-zA-Z0-9_]*}} : !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">
//       CHECK: %[[C0:.*]] = constant {{[0-9]+}} : i64
//       CHECK: %[[MC0:.*]] = memref_cast %arg0 : memref<2x3xf32> to memref<*xf32>
//       CHECK: %[[MC1:.*]] = memref_cast %arg2 : memref<2x3xf32> to memref<*xf32>
//       CHECK: call @__mlir_callback_1_input(%[[MC0]], %[[MC1]], %[[GA0]], %[[C0]]) : (memref<*xf32>, memref<*xf32>, !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">, i64) -> ()
...
//       CHECK: %[[GA0:.*]] = llvm.mlir.addressof @{{[a-zA-Z_][a-zA-Z0-9_]*}} : !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">
//       CHECK: %[[C0:.*]] = constant {{[0-9]+}} : i64
//       CHECK: %[[MC0:.*]] = memref_cast %arg0 : memref<3x6xf32> to memref<*xf32>
//       CHECK: %[[MC1:.*]] = memref_cast %arg1 : memref<6x4xf32> to memref<*xf32>
//       CHECK: %[[MC2:.*]] = memref_cast %arg2 : memref<3x4xf32> to memref<*xf32>
//       CHECK: %[[MC3:.*]] = memref_cast %arg3 : memref<3x4xf32> to memref<*xf32>
//       CHECK: call @__mlir_callback_3_inputs(%[[MC0]], %[[MC1]], %[[MC2]], %[[MC3]], %[[GA0]], %[[C0]]) : (memref<*xf32>, memref<*xf32>, memref<*xf32>, memref<*xf32>, !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">, i64) -> ()
...
//       CHECK: %[[GA0:.*]] = llvm.mlir.addressof @{{[a-zA-Z_][a-zA-Z0-9_]*}} : !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">
//       CHECK: %[[C0:.*]] = constant {{[0-9]+}} : i64
//       CHECK: %[[MC0:.*]] = memref_cast %arg0 : memref<3x2xf32> to memref<*xf32>
//       CHECK: %[[MC1:.*]] = memref_cast %arg1 : memref<2x3xf32> to memref<*xf32>
//       CHECK: %[[MC2:.*]] = memref_cast %arg2 : memref<2x2xf32> to memref<*xf32>
//       CHECK: call @__mlir_callback_2_inputs(%[[MC0]], %[[MC1]], %[[MC2]], %[[GA0]], %[[C0]]) : (memref<*xf32>, memref<*xf32>, memref<*xf32>, !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">, i64) -> ()
...
//       CHECK: %[[GA0:.*]] = llvm.mlir.addressof @{{[a-zA-Z_][a-zA-Z0-9_]*}} : !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">
//       CHECK: %[[C0:.*]] = constant {{[0-9]+}} : i64
//       CHECK: %[[MC0:.*]] = memref_cast %arg0 : memref<2x1x3x3xf32> to memref<*xf32>
//       CHECK: %[[MC1:.*]] = memref_cast %arg1 : memref<2x1x3x3xf32> to memref<*xf32>
//       CHECK: call @__mlir_callback_1_input(%[[MC0]], %[[MC1]], %[[GA0]], %[[C0]]) : (memref<*xf32>, memref<*xf32>, !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">, i64) -> ()
...
//       CHECK: %[[GA0:.*]] = llvm.mlir.addressof @{{[a-zA-Z_][a-zA-Z0-9_]*}} : !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">
//       CHECK: %[[C0:.*]] = constant {{[0-9]+}} : i64
//       CHECK: %[[MC0:.*]] = memref_cast %arg0 : memref<2x2x2x2xf32> to memref<*xf32>
//       CHECK: %[[MC1:.*]] = memref_cast %arg1 : memref<2x2x3x3xf32> to memref<*xf32>
//       CHECK: call @__mlir_callback_1_input(%[[MC0]], %[[MC1]], %[[GA0]], %[[C0]]) : (memref<*xf32>, memref<*xf32>, !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">, i64) -> ()
...
//       CHECK: %[[GA0:.*]] = llvm.mlir.addressof @{{[a-zA-Z_][a-zA-Z0-9_]*}} : !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">
//       CHECK: %[[C0:.*]] = constant {{[0-9]+}} : i64
//       CHECK: %[[MC0:.*]] = memref_cast %arg0 : memref<64x3x7x8x10xf32> to memref<*xf32>
//       CHECK: %[[MC1:.*]] = memref_cast %arg1 : memref<64x3x9x6x5xf32> to memref<*xf32>
//       CHECK: call @__mlir_callback_1_input(%[[MC0]], %[[MC1]], %[[GA0]], %[[C0]]) : (memref<*xf32>, memref<*xf32>, !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">, i64) -> ()
...
//       CHECK: %[[GA0:.*]] = llvm.mlir.addressof @{{[a-zA-Z_][a-zA-Z0-9_]*}} : !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">
//       CHECK: %[[C0:.*]] = constant {{[0-9]+}} : i64
//       CHECK: %[[MC0:.*]] = memref_cast %arg0 : memref<2x2x5x5xf32> to memref<*xf32>
//       CHECK: %[[MC1:.*]] = memref_cast %arg1 : memref<2x2x4x3xf32> to memref<*xf32>
//       CHECK: %[[MC2:.*]] = memref_cast %arg2 : memref<2x2x5x5xf32> to memref<*xf32>
//       CHECK: call @__mlir_callback_2_inputs(%[[MC0]], %[[MC1]], %[[MC2]], %[[GA0]], %[[C0]]) : (memref<*xf32>, memref<*xf32>, memref<*xf32>, !llvm<"{ i8, [3 x i64], [3 x i64], [3 x i64], [3 x i64] }*">, i64) -> ()
