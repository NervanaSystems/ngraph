...
NGRAPH_TEST(${BACKEND_NAME}, embedding_4x5_reverse)
{
    Shape shape{4};
    Shape rshape{4, 5};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, rshape);
    auto embed = make_shared<op::Embedding>(A, B);
    ...
    backend->call_with_validate(f0, {result0}, {a, b});
...
NGRAPH_TEST(${BACKEND_NAME}, embedding_10x1_arbitrary)
{
    Shape shape{10};
    Shape rshape{10, 1};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(${BACKEND_NAME}, embedding_10x1_arbitrary_index_type_int)
{
    Shape shape{10};
    Shape rshape{10, 1};
