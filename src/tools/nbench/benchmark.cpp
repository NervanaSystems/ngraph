                                                  ...
                                                  bool dump_results)
{
    ...
    {
        auto result = backend->create_tensor(out->get_output_element_type(0), out->get_shape());
        auto tensor_data =
            make_shared<runtime::HostTensor>(out->get_output_element_type(0), out->get_shape());
