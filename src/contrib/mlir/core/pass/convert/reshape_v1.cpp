...
template <>
mlir::Operation* ngraph::pass::NgDialectConversionPass::createOp<ngraph::op::v1::Reshape>(
    NgDialectConversionPass& NgDialectObj, const ngraph::Node* ngNode)
{
    auto node = dynamic_cast<const ngraph::op::v1::Reshape*>(ngNode);
    NGRAPH_CHECK(ngNode, node != nullptr, "ngNode ", ngNode->description(), " is not a v1::Reshape");
