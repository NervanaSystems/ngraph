...
template <>
mlir::Operation* ngraph::pass::NgDialectConversionPass::createOp<ngraph::op::v0::QuantizedConvolutionBiasSignedAdd>(
    NgDialectConversionPass& NgDialectObj, const ngraph::Node* ngNode)
{
    ...
    NGRAPH_CHECK(ngNode, node != nullptr, "ngNode ", ngNode->description(), " is not a v0::QuantizedConvolutionBiasSignedAdd");
