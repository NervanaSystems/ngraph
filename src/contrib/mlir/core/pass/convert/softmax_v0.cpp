...
template <>
mlir::Operation* ngraph::pass::NgDialectConversionPass::createOp<ngraph::op::v0::Softmax>(
    NgDialectConversionPass& NgDialectObj, const ngraph::Node* ngNode)
{
    auto node = dynamic_cast<const ngraph::op::v0::Softmax*>(ngNode);
    NGRAPH_CHECK(ngNode, node != nullptr, "ngNode ", ngNode->description(), " is not a v0::Softmax");
