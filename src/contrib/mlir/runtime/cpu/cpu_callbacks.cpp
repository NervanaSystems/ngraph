...
extern "C" void
    __mlir_ciface_callback_1_input(void* input, void* output, void* attrsPtr, OpType type)
{
...
extern "C" void __mlir_ciface_callback_2_inputs(
...
extern "C" void __mlir_ciface_callback_3_inputs(
