...
void op::v0::Acos::generate_adjoints(autodiff::Adjoints& adjoints, const OutputVector& deltas)
{
    auto delta = deltas.at(0);

    auto x = input_value(0);

    auto one = make_shared<op::v0::ScalarConstantLike>(x, 1.0);
    auto ones = make_shared<op::v0::BroadcastLike>(one, x, AxisSet());
