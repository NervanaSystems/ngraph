...
shared_ptr<Node>
    op::Minimum::copy_with_new_source_outputs(const OutputVector& new_source_outputs) const
{
...
void op::Minimum::generate_adjoints(autodiff::Adjoints& adjoints, const OutputVector& deltas)
{
