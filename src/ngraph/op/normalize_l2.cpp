...
constexpr NodeTypeInfo op::v0::NormalizeL2::type_info;
...
void op::v0::NormalizeL2::pre_validate_and_infer_types()
{
...
OutputVector op::v0::NormalizeL2::decompose_op() const
{
