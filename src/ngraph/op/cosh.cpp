...
shared_ptr<Node>
    op::Cosh::copy_with_new_source_outputs(const OutputVector& new_source_outputs) const
{
    check_new_source_outputs_count(this, new_source_outputs);
    return make_shared<Cosh>(new_source_outputs.at(0));
}

void op::Cosh::generate_adjoints(autodiff::Adjoints& adjoints, const NodeVector& deltas)
{
