        ...
        namespace v1
        {
            ...
            public:
                ...
                DeformableConvolution(const Output<Node>& arg,
                                      ...
                                      const uint64_t deformable_group = 1);
                ...
                uint64_t get_group() const { return m_group; }
                void set_group(const uint64_t group) { m_group = group; }
                uint64_t get_deformable_group() const { return m_deformable_group; }
                void set_deformable_group(const uint64_t deformable_group)
                {
