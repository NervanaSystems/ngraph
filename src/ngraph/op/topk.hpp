    ...
    namespace op
    {
        ...
        namespace v3
        {
            ...
            public:
                ...
                /// \param sort Specifies order of output elements and/or indices
                ///             Accepted values: none, index, value
                /// \param output_indices_type Specyfies type of produced indices
                TopK(const Output<Node>& data,
                     const Output<Node>& k,
                     const int64_t axis,
                     const std::string& mode,
                     const std::string& sort,
                     const element::Type& output_indices_type = element::i64);
                ...
                SortType get_sort_type() const { return m_sort; }
                void set_sort_type(const SortType sort) { m_sort = sort; }
                element::Type get_output_indices_type() const { return m_output_indices_type; }
                void set_output_indices_type(const element::Type& output_indices_type)
                {
            ...
            protected:
                ...
                Mode m_mode;
                SortType m_sort;
                element::Type m_output_indices_type{element::i64};
