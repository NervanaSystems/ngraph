...
op::Add::Add(const NodeOutput& arg0, const NodeOutput& arg1)
    : BinaryElementwiseArithmetic("Add", arg0, arg1)
{
    constructor_validate_and_infer_types();
}

shared_ptr<Node> op::Add::copy_with_new_source_outputs(const OutputVector& new_source_outputs) const
{
...
void op::Add::generate_adjoints(autodiff::Adjoints& adjoints, const OutputVector& deltas)
{
