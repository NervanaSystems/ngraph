...
op::QuantizedConvolution::QuantizedConvolution(const NodeOutput& input,
                                               ...
                                               const NodeOutput& input_scale,
                                               const NodeOutput& input_zero_point,
                                               const NodeOutput& filter_scale,
                                               const NodeOutput& filter_zero_point,
