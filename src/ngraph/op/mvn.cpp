...
constexpr NodeTypeInfo op::v0::MVN::type_info;

op::v0::MVN::MVN(const Output<Node>& data,
...
OutputVector op::v0::MVN::decompose_op() const
{
    ...
    else
    {
        ...
        variance = make_shared<op::v0::Sqrt>(variance);
        // add epsilon
        auto eps_node = op::v0::Constant::create(
