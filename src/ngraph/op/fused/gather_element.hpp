...
namespace ngraph
{
    namespace op
    {
        namespace v0
        {
            class NGRAPH_API GatherElement : public ngraph::op::util::FusedOp
            {
            public:
                static constexpr NodeTypeInfo type_info{"GatherElement", 0};
                const NodeTypeInfo& get_type_info() const override { return type_info; }
                GatherElement() = default;
                ...
                GatherElement(const Output<Node>& arg1, const Output<Node>& arg2, int64_t axis = 0);
