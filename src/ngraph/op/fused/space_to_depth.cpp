...
NodeVector op::SpaceToDepth::decompose_op() const
{
    ...
    if (data_shape.size() == 3)
    {
        ...
        data = builder::v1::reshape(data, data_shape);
    }
    ...
    auto flat_node = builder::v1::reshape(data, dispersed_shape);
    ...
    flat_node = builder::v1::reorder_axes(flat_node, axes_order);
    ...
    flat_node = builder::v1::reshape(flat_node, squeezed_shape);
