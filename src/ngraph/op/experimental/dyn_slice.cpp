...
void op::DynSlice::validate_and_infer_types()
{
    ...
    NODE_VALIDATION_CHECK(this,
                          strides_et.compatible(element::Type_t::i64),
                          "strides element type should be i64.");
    ...
    NODE_VALIDATION_CHECK(this,
                          ...
                          "lower_bounds should have rank 1, got ", lower_bounds_rank, ".");
    NODE_VALIDATION_CHECK(this,
                          upper_bounds_rank.compatible(1),
                          "upper_bounds should have rank 1, got ", upper_bounds_rank, ".");
    NODE_VALIDATION_CHECK(this,
                          strides_rank.compatible(1),
                          "strides should have rank 1, got ", strides_rank, ".");
