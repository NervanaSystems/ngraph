    ...
    namespace op
    {
        namespace v0
        {
            ...
            public:
                ...
                /// \param batch_indices   Indices of images in the batch matching the number or ROIs
                /// \param pooled_h        Height of the ROI output features
                /// \param pooled_w        Width of the ROI output features
                /// \param sampling_ratio  Number of sampling points used to compute an output element
