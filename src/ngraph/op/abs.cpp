...
shared_ptr<Node> op::Abs::copy_with_new_source_outputs(const OutputVector& new_source_outputs) const
{
...
void op::Abs::build_backprop(autodiff::Adjoints& adjoints, const OutputVector& deltas)
{
    ...
    adjoints.add_output_delta(x, delta * make_shared<op::Sign>(x));
}
