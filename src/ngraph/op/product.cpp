...
shared_ptr<Node>
    op::Product::copy_with_new_source_outputs(const OutputVector& new_source_outputs) const
{
    check_new_source_outputs_count(this, new_source_outputs);
    return make_shared<Product>(new_source_outputs.at(0), m_reduction_axes);
}
