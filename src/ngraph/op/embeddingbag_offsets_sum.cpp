...
constexpr NodeTypeInfo op::v0::EmbeddingBagOffsetsSum::type_info;

op::v0::EmbeddingBagOffsetsSum::EmbeddingBagOffsetsSum(const Output<Node>& emb_table,
...
shared_ptr<Node>
    op::v0::EmbeddingBagOffsetsSum::clone_with_new_inputs(const OutputVector& new_args) const
{
    check_new_args_count(this, new_args);
    if (new_args.size() == 3)
    {
        return make_shared<op::v0::EmbeddingBagOffsetsSum>(
