...
shared_ptr<Node>
    op::Slice::copy_with_new_source_outputs(const OutputVector& new_source_outputs) const
{
...
void op::Slice::generate_adjoints(autodiff::Adjoints& adjoints, const OutputVector& deltas)
{
    ...
    adjoints.add_output_delta_to_slice(x, delta, m_lower_bounds, m_upper_bounds, m_strides);
}
