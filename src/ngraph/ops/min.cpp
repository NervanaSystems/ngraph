...
op::Min::Min(const std::shared_ptr<Node>& arg, const AxisSet& reduction_axes)
    : RequiresTensorViewArgs("Min", {arg})
    , m_reduction_axes(reduction_axes)
{
    ...
    {
        throw ngraph_error("Argument for min must have numeric element type");
    }
    ...
    for (auto axis : m_reduction_axes)
    {
        ...
        {
            throw ngraph_error("Reduction axis for min is out of bounds");
        }
    }
