...
op::MaxReduce::MaxReduce(const std::shared_ptr<Node>& arg, const AxisSet& reduction_axes)
    : RequiresTensorViewArgs("MaxReduce", {arg})
    , m_reduction_axes(reduction_axes)
{
    ...
    {
        throw ngraph_error("Argument for max-reduce must have numeric element type");
    }
    ...
    for (auto axis : m_reduction_axes)
    {
        ...
        {
            throw ngraph_error("Reduction axis for max-reduce is out of bounds");
        }
    }
