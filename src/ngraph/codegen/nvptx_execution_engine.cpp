...
codegen::NVPTXExecutionEngine::NVPTXExecutionEngine()
...
bool codegen::NVPTXExecutionEngine::add_module(std::unique_ptr<llvm::Module>& module)
{
    if (module)
    {
...
void codegen::NVPTXExecutionEngine::finalize()
{
    if (m_execution_engine)
    {
