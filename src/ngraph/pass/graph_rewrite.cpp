...
bool pass::GraphRewrite::run_on_function(shared_ptr<Function> f)
{
    ...
    static bool s_rerun_dynamic_check = getenv_bool(ngraph::EnvVarEnum::NGRAPH_GRAPH_REWRITE_RERUN_DYNAMIC_CHECK);
...
{
    static const string nsf = getenv_string(ngraph::EnvVarEnum::NGRAPH_DISABLED_FUSIONS);
