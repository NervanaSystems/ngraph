...
public:
    ...
    void on_attribute(const std::string& name, const StringAdapter& adapter) override
    {
        m_json[name] = adapter.get_string();
    }
    void on_attribute(const std::string& name, const IntegerVectorAdapter& adapter) override
    {
