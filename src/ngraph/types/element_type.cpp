...
const element::Type element::u8(8, false, false, "int8_t");
const element::Type element::u32(32, false, false, "int32_t");
const element::Type element::u64(64, false, false, "int64_t");

element::Type::Type(size_t bitwidth, bool is_float, bool is_signed, const std::string& cname)
    : m_bitwidth{bitwidth}
    , m_is_float{is_float}
