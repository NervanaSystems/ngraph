...
NGRAPH_OP(BinaryConvolution, ngraph::op::v0)
NGRAPH_OP(Broadcast, ngraph::op::v2)
NGRAPH_OP(Bucketize, ngraph::op::v0)
...
NGRAPH_OP(ConvertLike, ngraph::op::v0)
...
NGRAPH_OP(DeformableConvolution, ngraph::op::v0)
NGRAPH_OP(DeformablePSROIPooling, ngraph::op::v0)
...
NGRAPH_OP(ExtractImagePatches, ngraph::op::v0)
NGRAPH_OP(FakeQuantize, ngraph::op::v0)
NGRAPH_OP(Floor, ngraph::op::v0)
NGRAPH_OP(FloorMod, ngraph::op::v0)
NGRAPH_OP(Gather, ngraph::op::v1)
NGRAPH_OP(GatherTree, ngraph::op::v0)
NGRAPH_OP(Greater, ngraph::op::v1)
NGRAPH_OP(GreaterEqual, ngraph::op::v0)
...
NGRAPH_OP(EmbeddingBagPackedSum, ngraph::op::v0)
NGRAPH_OP(EmbeddingSegmentsSum, ngraph::op::v0)
NGRAPH_OP(EmbeddingBagOffsetsSum, ngraph::op::v0)
