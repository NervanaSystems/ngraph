...
namespace ngraph
{
    namespace file_util
    {
        ...
        NGRAPH_API std::string
            path_join(const std::string& s1, const std::string& s2, const std::string& s3);
        NGRAPH_API std::string path_join(const std::string& s1,
                                         const std::string& s2,
                                         const std::string& s3,
                                         const std::string& s4);
        ...
        NGRAPH_API void
            iterate_files(const std::string& path,
        ...
        NGRAPH_API std::string tmp_filename(const std::string& extension = "");

        /// \brief Test for the existence of a path or file
        /// \param path The path to test
        /// \return true if the path exists, false otherwise
        NGRAPH_API bool exists(const std::string& path);
    }
}
