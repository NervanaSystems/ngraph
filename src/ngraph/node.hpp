...
namespace ngraph
{
    ...
    public:
        ...
        std::shared_ptr<Node> get_output_as_single_output_node(size_t i, bool for_get_output_element = true);
    ...
    public:
        ...
        std::shared_ptr<Node> as_single_output_node(bool for_get_output_element = true) const NGRAPH_DEPRECATED("Transitional.")
        {
