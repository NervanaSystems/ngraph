...
namespace ngraph
{
    ...
    // Returns the largest subgraph that can be placed on the same device starting from outputs
    // and traversing towards inputs
    std::shared_ptr<Function> build_largest_colocated_function(
