...
namespace ngraph
{
    ...
    public:
        ...
        {
        public:
            Iterator(const Shape& virtual_shape, bool is_end = false);
        ...
        Iterator begin() noexcept { return Iterator(m_virtual_shape); }
        Iterator end() noexcept { return Iterator(m_virtual_shape, true); }
    private:
