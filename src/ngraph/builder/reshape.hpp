...
namespace ngraph
{
    namespace builder
    {
        ...
        ///
        std::shared_ptr<Node> reshape(const NodeOutput& value, const Shape& shape);
        ...
        std::shared_ptr<Node> reorder_axes(const NodeOutput& value,
        ...
        std::shared_ptr<Node> transpose(const NodeOutput& value);
        ...
        std::shared_ptr<Node> flatten(const NodeOutput& value, int axis);
        ...
        ///
        /// \return The new value will be a 2D matrix representing the flattened input node.
        std::shared_ptr<Node> flatten(const NodeOutput& value, const NodeOutput& axis);
        ...
        ///
        std::shared_ptr<Node> squeeze(const NodeOutput& value, std::vector<std::size_t> axes = {0});
        ...
        ///
        std::shared_ptr<Node> collapse(const NodeOutput& value,
        ...
        ///
        std::shared_ptr<Node> expand_dims(const NodeOutput& value, std::size_t axis = 0);
    } // namespace  builder
} // namespace  ngraph
