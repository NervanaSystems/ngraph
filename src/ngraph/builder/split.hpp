...
namespace ngraph
{
    namespace builder
    {
        ...
        ///
        OutputVector split_value(const Output<Node>& value,
        ...
        /// \return     The vector containing multiple nodes we split input node into.
        ///
        NodeVector split(const std::shared_ptr<Node>& node,
                         const std::vector<size_t>& length_parts,
                         std::size_t axis = 0) NGRAPH_DEPRECATED("Replace with split_value.");
        ...
        /// \return     The vector containing multiple nodes we split input node into.
        ///
        OutputVector split_value(const Output<Node>& value, size_t split_parts, int axis = 0);

        /// \brief      Split output on specified axis into multiple parts.
        ///
        ...
        /// \return     The vector containing multiple nodes we split input node into.
        ///
        NodeVector split(const std::shared_ptr<Node>& node, size_t split_parts, int axis = 0)
            NGRAPH_DEPRECATED("Replace with split_value.");
    } // namespace builder
} // namespace ngraph
