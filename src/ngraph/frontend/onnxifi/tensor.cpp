    ...
    namespace onnxifi
    {
        ...
        std::shared_ptr<runtime::Tensor> OutputTensor::to_ng(runtime::Backend& backend) const
        {
            switch (m_tensor.dataType)
            {
                case ONNXIFI_DATATYPE_FLOAT16:
                case ONNXIFI_DATATYPE_FLOAT32:
                    return backend.create_tensor(element::f32, m_shape);
                case ONNXIFI_DATATYPE_FLOAT64:
                    return backend.create_tensor(element::f64, m_shape);
                case ONNXIFI_DATATYPE_INT8:
                    return backend.create_tensor(element::i8, m_shape);
                case ONNXIFI_DATATYPE_INT16:
                    return backend.create_tensor(element::i16, m_shape);
                case ONNXIFI_DATATYPE_INT32:
                    return backend.create_tensor(element::i32, m_shape);
                case ONNXIFI_DATATYPE_INT64:
                    return backend.create_tensor(element::i64, m_shape);
                case ONNXIFI_DATATYPE_UINT8:
                    return backend.create_tensor(element::u8, m_shape);
                case ONNXIFI_DATATYPE_UINT16:
                    return backend.create_tensor(element::u16, m_shape);
                case ONNXIFI_DATATYPE_UINT32:
                    return backend.create_tensor(element::u32, m_shape);
                case ONNXIFI_DATATYPE_UINT64:
                    return backend.create_tensor(element::u64, m_shape);
                default: throw status::unsupported_datatype{};
            }
        }
