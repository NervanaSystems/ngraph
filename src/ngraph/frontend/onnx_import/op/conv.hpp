            ...
            namespace detail
            {
                                        ...
                                        int groups)
                {
                    if (groups != 1)
                    {
                        ...
                        const size_t filters_group_size = n_filters_channels / groups;
                        ...
                        std::vector<size_t> filters_lower_bounds(filters->get_shape().size());
                        std::vector<size_t> filters_upper_bounds{filters->get_shape()};
