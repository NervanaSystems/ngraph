            ...
            namespace
            {
                ...
                struct LSTMNgInputMap
                {
                    ...
                    explicit LSTMNgInputMap(const Node& node)
                    {
                        ...
                        if (ng_inputs.size() > 3 && ng_inputs.at(3).get_node())
                        {
                        ...
                        if (ng_inputs.size() > 4 && ng_inputs.at(4).get_node())
                        {
                        ...
                        if (ng_inputs.size() > 5 && ng_inputs.at(5).get_node())
                        {
                        ...
                        // Shape [num_directions, batch_size, hidden_size]
                        if (ng_inputs.size() > 6 && ng_inputs.at(6).get_node())
                        {
                        ...
                        if (ng_inputs.size() > 7 && ng_inputs.at(7).get_node())
                        {
