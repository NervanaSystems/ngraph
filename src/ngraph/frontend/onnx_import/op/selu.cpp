        ...
        namespace op
        {
            namespace set_1
            {
                NodeVector selu(const Node& node)
                {
                    ...
                    auto alpha_node = default_opset::Constant::create(
                        data->get_element_type(), Shape{}, {alpha});

                    auto gamma_node = default_opset::Constant::create(
                        data->get_element_type(), Shape{}, {gamma});
