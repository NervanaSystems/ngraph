...
// Generated by the nGraph NVIDIAGPU backend
#include <cublas_v2.h>
#include <cuda.h>
#include <cuda_runtime.h>
#include <cudnn.h>
...
const string& runtime::nvidiagpu::ExternalFunction::get_header_source()
{
...
void runtime::nvidiagpu::ExternalFunction::emit_header()
{
    m_writer << get_header_source();
}

void runtime::nvidiagpu::ExternalFunction::emit_timer_functions()
{
    if (m_emit_timing)
    {
...
void runtime::nvidiagpu::ExternalFunction::emit_constant_declarations()
{
...
void runtime::nvidiagpu::ExternalFunction::emit_function_declarations()
{
...
void runtime::nvidiagpu::ExternalFunction::emit_temp_mem_pool_allocation(
...
void runtime::nvidiagpu::ExternalFunction::emit_functions()
{
    for (const auto& p : m_function_ordered_ops)
    {
...
void runtime::nvidiagpu::ExternalFunction::store_emitted_functions(const string& code)
{
...
void runtime::nvidiagpu::ExternalFunction::add_passes(ngraph::pass::Manager& pass_manager)
{
    auto femitter = bind(&ngraph::runtime::nvidiagpu::ExternalFunction::emit_op_as_function,
                         this,
                         placeholders::_1,
                         placeholders::_2);
...
void runtime::nvidiagpu::ExternalFunction::emit()
{
    emit_header();
...
void runtime::nvidiagpu::ExternalFunction::compile_function()
{
...
void runtime::nvidiagpu::ExternalFunction::emit_debug_function_entry(Node* node)
{
    if (m_emit_timing)
    {
...
void runtime::nvidiagpu::ExternalFunction::emit_debug_function_exit(Node* node)
{
    if (m_emit_timing)
    {
...
void runtime::nvidiagpu::ExternalFunction::propagate_in_place_input(
...
void runtime::nvidiagpu::ExternalFunction::propagate_in_place_output(
...
string runtime::nvidiagpu::ExternalFunction::strip_comments(const string& s) const
{
    stringstream out;
    for (size_t i = 0; i < s.size(); i++)
    {
...
void runtime::nvidiagpu::ExternalFunction::get_performance_data(
