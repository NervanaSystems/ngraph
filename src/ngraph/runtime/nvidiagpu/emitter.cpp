...
function<std::string(EMIT_ARGS)> runtime::nvidiagpu::Emitter::get_emit_function(const Node& node)
{
// This expands the op list in op_tbl.hpp into a list of enumerations that look like this:
// {<Abs typeid>, function<std::string(EMIT_ARGS)},
// {<Acos typeid>, function<std::string(EMIT_ARGS)},
// ...
#define NGRAPH_OP(a, b) {type_index(typeid(b::a)), runtime::nvidiagpu::Emitter::emit_##a},
...
std::string runtime::nvidiagpu::Emitter::emit_Abs(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Abs>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Acos(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Acos>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Add(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Add>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_All(EMIT_ARGS)
{
    throw unsupported_op("Unsupported op '" + node->description() + "'");
}

std::string runtime::nvidiagpu::Emitter::emit_AllReduce(EMIT_ARGS)
{
    throw unsupported_op("Unsupported op '" + node->description() + "'");
}

std::string runtime::nvidiagpu::Emitter::emit_And(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::And>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Any(EMIT_ARGS)
{
    throw unsupported_op("Unsupported op '" + node->description() + "'");
}

std::string runtime::nvidiagpu::Emitter::emit_ArgMax(EMIT_ARGS)
{
    cudnnReduceTensorOp_t reduce_op = CUDNN_REDUCE_TENSOR_MAX;
    return runtime::nvidiagpu::Emitter::emit_ArgReduce(
        compiled_function, function_name, node, args, out, reduce_op);
}

std::string runtime::nvidiagpu::Emitter::emit_ArgMin(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_ArgReduce(EMIT_ARGS, cudnnReduceTensorOp_t reduce_op)
{
    if (out[0].get_size() == 0)
    {
        // return;
...
std::string runtime::nvidiagpu::Emitter::emit_Asin(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Asin>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Atan(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Atan>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_AvgPool(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_AvgPoolBackprop(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_BatchNormInference(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_BatchNormTraining(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_BatchNormTrainingWithStats(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_BatchNormTrainingBackprop(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_Broadcast(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
...
std::string runtime::nvidiagpu::Emitter::emit_BroadcastLike(EMIT_ARGS)
{
    throw unsupported_op("Unsupported op '" + node->description() + "'");
}

std::string runtime::nvidiagpu::Emitter::emit_Ceiling(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Ceiling>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Concat(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
...
std::string runtime::nvidiagpu::Emitter::emit_Constant(EMIT_ARGS)
{
    return "";
}

std::string runtime::nvidiagpu::Emitter::emit_Convert(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Convert>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Convolution(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
...
std::string runtime::nvidiagpu::Emitter::emit_ConvolutionBackpropData(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        // return;
...
std::string runtime::nvidiagpu::Emitter::emit_ConvolutionBackpropFilters(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        // return;
...
std::string runtime::nvidiagpu::Emitter::emit_Cos(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Cos>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Cosh(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Cosh>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Divide(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Divide>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Dequantize(EMIT_ARGS)
{
    throw unsupported_op("Unsupported op '" + node->description() + "'");
}

std::string runtime::nvidiagpu::Emitter::emit_Dot(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
...
std::string runtime::nvidiagpu::Emitter::emit_Exp(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Exp>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Floor(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Floor>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_FunctionCall(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_Max(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
...
std::string runtime::nvidiagpu::Emitter::emit_Maximum(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Maximum>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_MaxPool(EMIT_ARGS)
{
    // assumes NC{d1,d2,...} format
...
std::string runtime::nvidiagpu::Emitter::emit_MaxPoolBackprop(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_Min(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
...
std::string runtime::nvidiagpu::Emitter::emit_Minimum(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Minimum>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Multiply(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Multiply>(
        compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Negative(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Negative>(
        compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Not(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Not>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_NotEqual(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::NotEqual>(
        compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_OneHot(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
...
std::string runtime::nvidiagpu::Emitter::emit_Or(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Or>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Pad(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_Parameter(EMIT_ARGS)
{
    return "";
}

std::string runtime::nvidiagpu::Emitter::emit_Power(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Power>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Product(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_Quantize(EMIT_ARGS)
{
    throw unsupported_op("Unsupported op '" + node->description() + "'");
}

std::string runtime::nvidiagpu::Emitter::emit_Reduce(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
...
std::string runtime::nvidiagpu::Emitter::emit_ReduceWindow(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_Relu(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Relu>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_ReluBackprop(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::ReluBackprop>(
        compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_ReplaceSlice(EMIT_ARGS)
{
    // assumes NC{d1,d2,...} format
...
std::string runtime::nvidiagpu::Emitter::emit_Reshape(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
...
std::string runtime::nvidiagpu::Emitter::emit_Result(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_Reverse(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
...
std::string runtime::nvidiagpu::Emitter::emit_ReverseSequence(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
...
std::string runtime::nvidiagpu::Emitter::emit_Rnn(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_ScalarConstantLike(EMIT_ARGS)
{
    throw unsupported_op("Unsupported op '" + node->description() + "'");
}

std::string runtime::nvidiagpu::Emitter::emit_Select(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Select>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_SelectAndScatter(EMIT_ARGS)
{
    throw unsupported_op("Unsupported op '" + node->description() + "'");
}
...
std::string runtime::nvidiagpu::Emitter::emit_Softmax(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_Sqrt(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Sqrt>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_StopGradient(EMIT_ARGS)
{
    throw unsupported_op("Unsupported op '" + node->description() + "'");
}

std::string runtime::nvidiagpu::Emitter::emit_Subtract(EMIT_ARGS)
{
...
std::string runtime::nvidiagpu::Emitter::emit_Sum_1(EMIT_ARGS)
...
std::string runtime::nvidiagpu::Emitter::emit_Tan(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Tan>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_Tanh(EMIT_ARGS)
{
    return emit_elementwise<ngraph::op::Tanh>(compiled_function, function_name, node, args, out);
}

std::string runtime::nvidiagpu::Emitter::emit_TopK(EMIT_ARGS)
{
    if (out[0].get_size() == 0)
    {
        return "";
