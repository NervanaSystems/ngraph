...
runtime::hybrid::BackendWrapper::BackendWrapper(const string& backend_name,
...
shared_ptr<runtime::Tensor> runtime::hybrid::BackendWrapper::create_tensor(const element::Type& element_type,
                                                          const Shape& shape)
{
...
bool runtime::hybrid::BackendWrapper::compile(shared_ptr<Function> func)
{
    return m_backend->compile(func);
}

bool runtime::hybrid::BackendWrapper::call(shared_ptr<Function> func,
...
bool runtime::hybrid::BackendWrapper::is_supported(const Node& node) const
{
