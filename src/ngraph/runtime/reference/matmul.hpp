    ...
    namespace runtime
    {
        namespace reference
        {
                        ...
                        bool transpose_arg1)
            {
                ...
                vector<T> wip_arg0_vec;
                vector<T> wip_arg1_vec;
                vector<T> arg0_br_data;
                vector<T> arg1_br_data;
                ...
                {
                    wip_arg0_vec.reserve(shape_size(arg0_shape));
                    auto axis_vector = get_transpose_order(arg0_shape);
                    swap(wip_arg0_shape[arg0_rank - 1], wip_arg0_shape[arg0_rank - 2]);
                    reference::reshape(
                        arg0, wip_arg0_vec.data(), arg0_shape, axis_vector, wip_arg0_shape);

                    arg0_update = wip_arg0_vec.data();
                }

                if (transpose_arg1 && arg1_rank > 1)
                {
                    wip_arg1_vec.reserve(shape_size(arg1_shape));
                    auto axis_vector = get_transpose_order(arg1_shape);
                    swap(wip_arg1_shape[arg1_rank - 1], wip_arg1_shape[arg1_rank - 2]);
                    reference::reshape(
                        arg1, wip_arg1_vec.data(), arg1_shape, axis_vector, wip_arg1_shape);

                    arg1_update = wip_arg1_vec.data();
                }
                ...
                if (arg0_rank > 2 && arg1_rank > 2)
                {
                    ...
                    if (arg0_br_target_shape != wip_arg0_shape)
                    {
                        ...
                        {
                            arg0_br_data.reserve(shape_size(arg0_br_target_shape));
                    ...
                    if (arg1_br_target_shape != wip_arg1_shape)
                    {
                        ...
                        if (!broadcast_axes.empty())
                        {
                            arg1_br_data.reserve(shape_size(arg1_br_target_shape));
                ...
                Shape dot_arg1_shape = (arg1_rank > 2) ? Shape{wip_arg1_shape[arg1_rank - 2],
                                                       ...
                                                       : wip_arg1_shape;
                Shape dot_output_shape{out_shape[out_rank - 2], out_shape[out_rank - 1]};
