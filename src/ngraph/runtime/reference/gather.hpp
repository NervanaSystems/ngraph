    ...
    namespace runtime
    {
        namespace reference
        {
                        ...
                        size_t axis)
            {
                ...
                CoordinateTransform out_outer_transform(
                    out_shape, out_outer_start_corner, out_outer_end_corner, out_outer_strides, out_outer_axis_order);
                ...
                CoordinateTransform params_outer_transform(
                    params_shape, params_outer_start_corner, params_outer_end_corner, params_outer_strides, params_outer_axis_order);
                ...
                CoordinateTransform indices_outer_transform(
                    indices_shape, indices_outer_start_corner, indices_outer_end_corner, indices_outer_strides, indices_outer_axis_order);
