                                                ...
                                                GPUShape input_order)
{
    ...
    std::unique_ptr<gpu::primitive> reshape(new gpu::primitive{[=](void** inputs,
                                                                   void** outputs) mutable {
        void* input_strides_d = runtime::gpu::invoke_memory_primitive(m_ctx, idx_input_strides);
        void* trans_strides_d = runtime::gpu::invoke_memory_primitive(m_ctx, idx_trans_strides);
