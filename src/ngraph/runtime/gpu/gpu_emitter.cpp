        ...
        namespace gpu
        {
            ...
            void GPU_Emitter::EMITTER_DECL(ngraph::op::Add)
            {
                ...
                writer.block_begin();
                {
                    ...
                    auto index = cudnn_emitter->build_tensor_op(CUDNN_OP_TENSOR_ADD,
                                                                out[0].get_type(),
                                                                args[0].get_shape(),
                                                                1.0,
                                                                1.0,
            ...
            void GPU_Emitter::EMITTER_DECL(ngraph::op::Convolution)
            {
                ...
                if (padding_below_diff.size() > 3)
                {
                    ...
                    size_t reshape_data_index =
                        cuda_emitter->build_reshape({{args[0].get_type(), args[0].get_type()}},
                                                    input_shape,
                                                    input_order);
                    ...
                    size_t reshape_filter_index =
                        cuda_emitter->build_reshape({{args[1].get_type(), args[1].get_type()}},
                                                    filter_shape,
                                                    input_order);
                    ...
                    size_t conv_index = cuda_emitter->build_convolution({{args[0].get_type(), args[1].get_type(), out[0].get_type()}},
                        input_shape,
                        padding_below_diff,
                ...
                else
                {
                    ...
                    if (pad_required || is_deconvolution)
                    {
                        ...
                        auto& cuda_emitter =
                            external_function->get_primitive_emitter()->get_cuda_emitter();
                        auto pad_dynamic_index = cuda_emitter->build_pad_dynamic({{args[0].get_type(), out[0].get_type()}},
                            input_shape,
                            input_shape_padded,
                            padding_below,
                            padding_interior);
            ...
            void GPU_Emitter::EMITTER_DECL(ngraph::op::Maximum)
            {
                ...
                writer.block_begin();
                {
                    auto& cudnn_emitter =
                        external_function->get_primitive_emitter()->get_cudnn_emitter();
                    auto index = cudnn_emitter->build_tensor_op(CUDNN_OP_TENSOR_MAX,
                                                                out[0].get_type(),
                                                                args[0].get_shape(),
                                                                1.0,
                                                                1.0,
            ...
            void GPU_Emitter::EMITTER_DECL(ngraph::op::Minimum)
            {
                ...
                writer.block_begin();
                {
                    auto& cudnn_emitter =
                        external_function->get_primitive_emitter()->get_cudnn_emitter();
                    auto index = cudnn_emitter->build_tensor_op(CUDNN_OP_TENSOR_MIN,
                                                                out[0].get_type(),
                                                                args[0].get_shape(),
                                                                1.0,
                                                                1.0,
            ...
            void GPU_Emitter::EMITTER_DECL(ngraph::op::Broadcast)
            {
                ...
                auto bcast_index =
                    cuda_emitter->build_broadcast({{args[0].get_type(), out[0].get_type()}},
                                                  result_shape,
                                                  axes);
            ...
            void GPU_Emitter::EMITTER_DECL(ngraph::op::ReverseSequence)
            {
                ...
                auto rs_index = cuda_emitter->build_reverse_sequence({{args[0].get_type(), args[1].get_type(), out[0].get_type()}},
                    arg_shape0,
                    arg_shape1,
                    out_shape,
                    bi,
            ...
            void GPU_Emitter::EMITTER_DECL(ngraph::op::Multiply)
            {
                ...
                writer.block_begin();
                {
                    auto& cudnn_emitter =
                        external_function->get_primitive_emitter()->get_cudnn_emitter();
                    auto index = cudnn_emitter->build_tensor_op(CUDNN_OP_TENSOR_MUL,
                                                                out[0].get_type(),
                                                                args[0].get_shape(),
                                                                1.0,
                                                                1.0,
            ...
            void GPU_Emitter::EMITTER_DECL(ngraph::op::Sqrt)
            {
                ...
                writer.block_begin();
                {
                    auto& cudnn_emitter =
                        external_function->get_primitive_emitter()->get_cudnn_emitter();
                    auto index = cudnn_emitter->build_tensor_op(CUDNN_OP_TENSOR_SQRT,
                                                                out[0].get_type(),
                                                                args[0].get_shape(),
                                                                1.0,
                                                                0,
                ...
                writer.block_begin();
                {
                    if (out[0].get_size() != 0)
                    {
                        ...
                        else
                        {
                            ...
                            auto& cudnn_emitter =
                                external_function->get_primitive_emitter()->get_cudnn_emitter();
                            auto reduce_index = cudnn_emitter->build_reduce_forward(reduce_tensor_op,
                                out[0].get_type(),
                                args[0].get_shape(),
                ...
                writer.block_begin();
                {
                    if (out[0].get_size() != 0)
                    {
                        ...
                        else
                        {
                            ...
                            reduce_index = cuda_emitter->build_reduce_window(it->second,
                                dtypes,
                                args[0].get_shape(),
                                out[0].get_shape(),
                ...
                writer.block_begin();
                {
                    ...
                    if (input_shape.size() <= 5)
                    {
                        ...
                        if ((input_shape.size() == 3 || num_nontrivial_dims == 1))
                        {
                            ...
                            max_pool_index = cuda_emitter->build_1d_max_pool({{args[0].get_type(), out[0].get_type()}},
                                input_shape,
                                result_shape,
                        ...
                        else if (input_shape.size() == 4 || input_shape.size() == 5)
                        {
                            ...
                            max_pool_index = cudnn_emitter->build_pooling(CUDNN_POOLING_MAX,
                                out[0].get_type(),
                ...
                writer.block_begin();
                {
                    ...
                    else if (input_shape.size() <= 5)
                    {
                        ...
                        if (input_shape.size() == 4 || input_shape.size() == 5)
                        {
                            ...
                            avg_pool_index = cudnn_emitter->build_pooling(cudnn_avg_type,
                                out[0].get_type(),
                                CUDNNEmitter::Prop::Forward,
                                input_shape,
                                result_shape,
            ...
            void GPU_Emitter::EMITTER_DECL(ngraph::op::ReplaceSlice)
            {
                ...
                writer.block_begin();
                {
                    ...
                    else
                    {
                        ...
                        auto replace_slice_index = cuda_emitter->build_replace_slice({{args[0].get_type(), args[1].get_type(), out[0].get_type()}},
                            input_shape,
                            source_shape,
                            lower_bounds,
                            upper_bounds,
                ...
                writer.block_begin();
                {
                    ...
                    if (axes.size() != tensor_shape.size())
                    {
                        ...
                        size_t exp_sum_reduce =
                            cuda_emitter
                                ->build_elementwise_collective<ngraph::op::Exp, ngraph::op::Add>({{args[0].get_type(), out[0].get_type()}},
                                    args[0].get_shape(),
                                    {},
                                    axes,
                                    true /* multi-output */);
                        ...
                        size_t div_broadcast =
                            cuda_emitter->build_elementwise_collective<ngraph::op::Divide>({{out[0].get_type(), out[0].get_type(), out[0].get_type()}},
                                out[0].get_shape(),
                                {1},
                                axes);
