...
static const runtime::gpu::OpMap dispatcher{
    ...
    {TI(ngraph::op::BatchNormInference),
     &runtime::gpu::GPU_Emitter::emit<ngraph::op::BatchNormInference>},
    {TI(ngraph::op::BatchNormTraining),
     &runtime::gpu::GPU_Emitter::emit<ngraph::op::BatchNormTraining>},
    {TI(ngraph::op::BatchNormTrainingBackprop),
     &runtime::gpu::GPU_Emitter::emit<ngraph::op::BatchNormTrainingBackprop>},
