        ...
        case OP_TYPEID::ConvolutionBackpropFilters:
        {
                ...
                (win_dilation.size() > 2) || (get_output_type(op) != element::f32))
            {
                do_convolution_operation(topology,
                                         ...
                                         conv_op->get_window_dilation_strides_forward(),
                                         conv_op->get_window_movement_strides_forward(),
                                         conv_op->get_data_dilation_strides_forward(),
                                         1,
                                         0,
                                         0,
        ...
        case OP_TYPEID::ConvolutionBackpropData:
        {
                ...
                ((pad_below.at(0) == pad_above.at(0)) && (pad_below.at(1) == pad_above.at(1))))
            {
                do_convolution_operation(topology,
                                         ...
                                         get_output_shape(op),
                                         get_output_type(op),
                                         conv_op->compute_backward_delta_out_pad_below(),
                                         conv_op->get_data_dilation_strides_forward(),
                                         conv_op->get_window_dilation_strides_forward(),
                                         conv_op->get_window_movement_strides_forward(),
                                         0,
