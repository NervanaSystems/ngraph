    ...
    : config_{config}
{
    ...
    pass_manager_.register_pass<ngraph::pass::LikeReplacement>();
    pass_manager_.register_pass<ngraph::pass::NopElimination>();
    pass_manager_.register_pass<ngraph::pass::AlgebraicSimplification>();
    pass_manager_.register_pass<ngraph::pass::CommonSubexpressionElimination>();
    pass_manager_.register_pass<ngraph::pass::CoreFusion>();
    // pass_manager_.register_pass<ngraph::pass::GetOutputElementElimination>(); // breaks BatchNorm backprop
    pass_manager_.register_pass<ngraph::pass::Liveness>();
}
