    ...
    namespace runtime
    {
        namespace plaidml
        {
            ...
            void Impl<op::AvgPool>::operator()()
            {
                ...
                // Overpadding occurs iff any padding value is >= its corresponding window shape.
                // If this happens, we need to conditionally set the padded values to the operation default.
