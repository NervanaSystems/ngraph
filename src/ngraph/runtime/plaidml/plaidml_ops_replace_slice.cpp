    ...
    namespace runtime
    {
        namespace plaidml
        {
            ...
            void Impl<op::ReplaceSlice>::operator()()
            {
                ...
                // For ReplaceSlice:
                //
                // * Pad the second tensor to match the first
                // * (same-size dimensions and offset according to the
                // * lower bounds of the replacement, with the desired
                // * stridings)
                //
                // * Generate a boolean tensor of the same shape as
                // * the first, where true == "Do the replacement".
                //
