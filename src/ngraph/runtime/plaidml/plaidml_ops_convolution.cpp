...
namespace ngraph
{
    namespace runtime
    {
        namespace plaidml
        {
            ...
            // ConvolutionBackpropFilters implements the derivative of a convolution with respect to its filter input.
            template <>
            ...
            // ConvolutionBackpropData implements the derivative of a convolution with respect to its data input.
            template <>
