...
// Licensed under the Apache License, VersioeckCUDNN(cudnnCreateOpTensorDescriptor(&opTensorDesc));                                                                                                        | 43                                 cudaMalloc((void**) &d_out, sizeof(float) * count); 2.0 (the "License");
