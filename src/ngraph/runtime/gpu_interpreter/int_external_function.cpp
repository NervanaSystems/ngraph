...
runtime::gpu_interpreter::ExternalFunction::ExternalFunction(const shared_ptr<Function>& function,
...
void runtime::gpu_interpreter::ExternalFunction::compile()
{
    if (m_is_compiled)
    {
        return;
...
shared_ptr<runtime::CallFrame> runtime::gpu_interpreter::ExternalFunction::make_call_frame()
{
    if (!m_is_compiled)
    {
        compile();
    ...
    return make_shared<runtime::gpu_interpreter::INT_CallFrame>(shared_from_this(), m_function);
}
