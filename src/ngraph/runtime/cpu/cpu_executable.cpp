                                                                              ...
                                                                              void* memory_pointer)
{
    ...
    return make_shared<runtime::cpu::CPUTensor>(
        parameter->get_element_type(), parameter->get_output_shape(0), memory_pointer);
}
...
shared_ptr<runtime::Tensor> runtime::cpu::CPU_Executable::create_output_tensor(size_t output_index)
{
    ...
    return make_shared<runtime::cpu::CPUTensor>(result->get_element_type(),
                                                                               ...
                                                                               void* memory_pointer)
{
    shared_ptr<op::Result> result = get_result(output_index);
    return make_shared<runtime::cpu::CPUTensor>(
        result->get_element_type(), result->get_output_shape(0), memory_pointer);
}
