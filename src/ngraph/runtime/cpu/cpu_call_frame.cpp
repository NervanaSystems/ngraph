...
CPU_CallFrame::CPU_CallFrame(std::shared_ptr<CPU_ExternalFunction> external_function,
...
void CPU_CallFrame::tensor_call(
...
void CPU_CallFrame::call(const std::vector<std::shared_ptr<ngraph::runtime::Value>>& arguments,
