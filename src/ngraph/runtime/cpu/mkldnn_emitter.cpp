...
size_t MKLDNNEmitter::build_convolution(const ngraph::Node* node,
                                        ...
                                        const std::vector<TensorViewWrapper>& out)
{
    ...
    auto input_format = mkldnn_utils::get_input_mkldnn_format(node, 0);
    ...
    auto output_format = mkldnn_utils::get_output_mkldnn_format(node, 0);

    auto input_data_desc = build_memory_descriptor(args[0], input_format);
    auto weights_desc = build_memory_descriptor(args[1], weights_format);
    auto result_desc = build_memory_descriptor(out[0], output_format);

    return build_convolution_forward(input_data_desc,
                                     weights_desc,
                                     result_desc,
...
size_t MKLDNNEmitter::build_convolution_relu(const ngraph::Node* node,
                                             const std::vector<TensorViewWrapper>& args,
                                             const std::vector<TensorViewWrapper>& out)
{
...
size_t MKLDNNEmitter::build_convolution_bias(const ngraph::Node* node,
                                             const std::vector<TensorViewWrapper>& args,
                                             const std::vector<TensorViewWrapper>& out)
{
...
size_t MKLDNNEmitter::build_convolution_bias_add(const ngraph::Node* node,
                                                 const std::vector<TensorViewWrapper>& args,
                                                 const std::vector<TensorViewWrapper>& out)
{
