...
// CPUFusion algorithm:
// CPUFusion processes an input graph in an topological order(i.e. args before users)
...
// Next, CPUFusion will invoke matchers registered in an order registered in a c-tor
...
// In this case, you should be able to request another pass of CPUFusion.
...
// This will schedule another pass of CPUFusion with the following fusion.
