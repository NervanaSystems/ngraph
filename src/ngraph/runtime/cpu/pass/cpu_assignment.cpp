    ...
    namespace runtime
    {
        namespace cpu
        {
            namespace pass
            {
                ...
                template <>
                void CPUAssignment::ASSIGN_DECL(ngraph::op::GroupConvolutionBackpropData)
                {
                    auto convolution = static_cast<op::GroupConvolutionBackpropData*>(node);
                ...
                template <>
                void CPUAssignment::ASSIGN_DECL(ngraph::op::GroupConvolutionBackpropFilters)
                {
                    auto convolution = static_cast<op::GroupConvolutionBackpropFilters*>(node);
...
static const runtime::cpu::pass::AssignOpMap s_dispatcher{
    ...
    {TI(ngraph::op::GroupConvolutionBackpropData),
     &runtime::cpu::pass::CPUAssignment::assign<ngraph::op::GroupConvolutionBackpropData>},
    ...
    {TI(ngraph::op::GroupConvolutionBackpropFilters),
     &runtime::cpu::pass::CPUAssignment::assign<ngraph::op::GroupConvolutionBackpropFilters>},
