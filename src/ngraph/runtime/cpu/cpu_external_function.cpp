...
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Add);
#ifdef NGRAPH_DISTRIBUTED_ENABLE
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::AllReduce);
#endif
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::MatmulBias);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Dot);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Multiply);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Parameter);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Abs);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Any);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::All);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchDot);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Concat);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Divide);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Equal);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::GetOutputElement);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Greater);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::GreaterEq);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Less);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::LessEq);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Log);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Maximum);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Minimum);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Negative);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::NotEqual);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Power);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Select);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Subtract);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Broadcast);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Convert);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Constant);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Reshape);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sign);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Slice);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sum);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::EmbeddingLookup);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Exp);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sin);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sinh);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Cos);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Cosh);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Tan);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Tanh);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::TopK);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Asin);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ArgMin);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ArgMax);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Acos);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Atan);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ReplaceSlice);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::UpdateSlice);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::OneHot);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Floor);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Ceiling);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sqrt);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Convolution);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionBackpropFilters);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionBackpropData);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::GroupConvolution);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionBias);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConvolutionBias);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConvolutionBiasAdd);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConvolutionBiasSignedAdd);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedDotBias);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedDot);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionRelu);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConvolution);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConvolutionRelu);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionBiasAdd);
// conv+bias backprop for data share the same implementation as ConvolutionBackpropData
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionBiasBackpropFiltersBias);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::runtime::cpu::op::ConvertLayout);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Not);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::MaxPool);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedMaxPool);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedAvgPool);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::MaxPoolWithIndices);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Reverse);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ReverseSequence);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Result);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::AvgPool);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::AvgPoolBackprop);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Pad);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchNormTraining);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchNormInference);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchNormTrainingRelu);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchNormInferenceRelu);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchNormTrainingBackprop);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BoundedRelu);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Lstm);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::MaxPoolBackprop);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::MaxPoolWithIndicesBackprop);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Product);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Max);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Min);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Relu);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ReluBackprop);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Rnn);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sigmoid);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::SigmoidMultiply);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::SigmoidMultiplyBackprop);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Softmax);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::SigmoidBackprop);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::And);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Or);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::LeakyRelu);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::runtime::cpu::op::LoopKernel);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::LRN);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::GenerateMask);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionAdd);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Quantize);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Dequantize);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::GroupConvolutionBias);
template<> extern void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConcat);
