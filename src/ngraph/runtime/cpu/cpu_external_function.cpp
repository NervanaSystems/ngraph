...
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Add);
#ifdef NGRAPH_DISTRIBUTED_ENABLE
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::AllReduce);
#endif
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::MatmulBias);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Dot);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Multiply);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Parameter);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Abs);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Any);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::All);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchDot);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Concat);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Divide);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Equal);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::GetOutputElement);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Greater);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::GreaterEq);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Less);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::LessEq);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Log);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Maximum);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Minimum);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Negative);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::NotEqual);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Power);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Select);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Subtract);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Broadcast);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Convert);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Constant);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Reshape);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sign);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Slice);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sum);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::EmbeddingLookup);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Exp);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sin);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sinh);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Cos);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Cosh);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Tan);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Tanh);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::TopK);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Asin);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ArgMin);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ArgMax);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Acos);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Atan);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ReplaceSlice);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::UpdateSlice);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::OneHot);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Floor);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Ceiling);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sqrt);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Convolution);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionBackpropFilters);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionBackpropData);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::GroupConvolution);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionBias);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConvolutionBias);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConvolutionBiasAdd);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConvolutionBiasSignedAdd);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedDotBias);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedDot);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionRelu);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConvolution);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConvolutionRelu);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionBiasAdd);
// conv+bias backprop for data share the same implementation as ConvolutionBackpropData
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionBiasBackpropFiltersBias);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::runtime::cpu::op::ConvertLayout);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Not);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::MaxPool);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedMaxPool);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedAvgPool);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::MaxPoolWithIndices);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Reverse);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ReverseSequence);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Result);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::AvgPool);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::AvgPoolBackprop);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Pad);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchNormTraining);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchNormInference);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchNormTrainingRelu);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchNormInferenceRelu);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BatchNormTrainingBackprop);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::BoundedRelu);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Lstm);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::MaxPoolBackprop);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::MaxPoolWithIndicesBackprop);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Product);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Max);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Min);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Relu);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ReluBackprop);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Rnn);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Sigmoid);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::SigmoidMultiply);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::SigmoidMultiplyBackprop);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Softmax);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::SigmoidBackprop);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::And);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Or);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::LeakyRelu);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::runtime::cpu::op::LoopKernel);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::LRN);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::GenerateMask);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::ConvolutionAdd);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Quantize);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::Dequantize);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::GroupConvolutionBias);
extern template void runtime::cpu::CPU_Emitter::EMITTER_DECL(ngraph::op::QuantizedConcat);
