        ...
        namespace cpu
        {
            ...
            void Builder::BUILDER_DECL(ngraph::op::BoundedRelu)
            {
                ...
                if (runtime::cpu::mkldnn_utils::use_mkldnn_kernel(node))
                {
                    ...
                    auto functor = [&, bounded_relu_index](CPURuntimeContext* ctx, int arena) {
                ...
                else
                {
                    ...
                    auto functor = [&, kernel, alpha, count](CPURuntimeContext* ctx, int arena) {
                        kernel(input_tensor, out_tensor, alpha, count, arena);
                    };
                    functors.emplace_back(functor);
                }
            }
