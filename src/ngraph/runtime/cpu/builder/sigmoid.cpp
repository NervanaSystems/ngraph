    ...
    namespace runtime
    {
        namespace cpu
        {
            ...
            void Builder::BUILDER_DECL(ngraph::op::Sigmoid)
            {
                ...
                size_t s_size = QUERY_SCRATCHPAD(eltwise_forward, sigmoid_desc);
                ...
                auto functor =
                    [&, sigmoid_desc, sigmoid_index, s_size, arg0_buffer_index, out_buffer_index](
                        ...
                        cpu::mkldnn_utils::mkldnn_invoke_primitive(
                            ctx, sigmoid_index, deps, cpu::mkldnn_utils::OpType::SIGMOID, s_size);
                    };
