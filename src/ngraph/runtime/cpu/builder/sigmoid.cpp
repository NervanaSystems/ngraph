    ...
    namespace runtime
    {
        namespace cpu
        {
            ...
            void Builder::BUILDER_DECL(ngraph::op::Sigmoid)
            {
                ...
                auto functor = [&, sigmoid_index](CPURuntimeContext* ctx, int arena) {
            ...
            void Builder::BUILDER_DECL(ngraph::op::SigmoidMultiply)
            {
                ...
                auto functor = [&, index, tensor_size](CPURuntimeContext* ctx, int arena) {
                    ngraph::runtime::cpu::kernel::sigmoid_multiply(
                        arg0_tensor, arg1_tensor, out_tensor, tensor_size, index, arena);
                };
