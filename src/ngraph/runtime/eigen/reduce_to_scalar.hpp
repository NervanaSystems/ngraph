        ...
        namespace eigen
        {
            ...
            public:
                ...
                virtual void execute(CallFrame& call_frame) const override
                {
                    ...
                    auto f = [ef](typename ET::type x,
                                  typename ET::type y) -> typename ET::type
                             {
                                 std::shared_ptr<CallFrame> cf = ef->make_call_frame();
                    ...
                    EigenArray1d<ET>(call_frame,m_out) = EigenArray1d<ET>(call_frame,m_arg0).redux(f);
                }
