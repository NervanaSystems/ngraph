...
namespace ngraph
{
    namespace runtime
    {
        namespace eigen
        {
            ...
            template <typename T>
            void subtract(std::shared_ptr<T>& arg0, std::shared_ptr<T>& arg1, std::shared_ptr<T>& out)
            {
                subtract(&*arg0, &*arg1, &*out);
            }
            ...
            public:
                ...
                {
                    subtract(call_frame.get_parameterized_tensor<ET>(m_arg0),
