...
#include "ngraph/runtime/opt_kernel/coordinate_iterator.hpp"
#include "ngraph/log.hpp"

using namespace ngraph;
using namespace std;

class Indexer_0 : public runtime::opt_kernel::CoordinateIterator::Indexer
{
public:
...
class Indexer_1 : public runtime::opt_kernel::CoordinateIterator::Indexer
{
public:
...
class Indexer_2 : public runtime::opt_kernel::CoordinateIterator::Indexer
{
public:
...
class Indexer_3 : public runtime::opt_kernel::CoordinateIterator::Indexer
{
public:
...
class Indexer_4 : public runtime::opt_kernel::CoordinateIterator::Indexer
{
public:
...
class Indexer_5 : public runtime::opt_kernel::CoordinateIterator::Indexer
{
public:
...
class Indexer_6 : public runtime::opt_kernel::CoordinateIterator::Indexer
{
public:
...
runtime::opt_kernel::CoordinateIterator::CoordinateIterator(const Shape& in_shape,
                                                    const AxisVector& in_axis_order)
{
    ...
    default: throw runtime_error("Unsupported dimention in CoordinateIterator");
    }
}

size_t runtime::opt_kernel::CoordinateIterator::next()
{
