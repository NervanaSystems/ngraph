            ...
            namespace kernel
            {
                                       ...
                                       bool include_padding_in_avg_computation)
                {
                    ...
                    for (const Coordinate& delta_coord : delta_transform)
                    {
                        ...
                        AxisVector source_window_transform_source_axis_order(2 +
                                                                             n_image_dimensions);
                        CoordinateDiff source_window_transform_padding_below(2 +
                                                                             n_image_dimensions);
                        CoordinateDiff source_window_transform_padding_above(2 +
                                                                             n_image_dimensions);
                        ...
                        {
                            if (source_window_transform.has_source_coordinate(
                                    source_window_coord) ||
                        ...
                        for (const Coordinate& source_window_coord : source_window_transform)
                        {
                            ...
                            {
                                size_t out_index =
                                    source_window_transform.index(source_window_coord);
                                out[out_index] += delta[delta_transform.index(delta_coord)] /
                                                  num_elements_in_window;
                            }
                        }
                    }
