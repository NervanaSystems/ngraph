...
void runtime::rpi::RPIBackend::set_nan_check(shared_ptr<Function> func, bool enable)
{
...
void runtime::rpi::RPIBackend::perform_nan_check(const vector<shared_ptr<HostTensor>>& tensors,
                                                 const Node* op)
{
    size_t arg_number = 1;
