...
void regclass_pyngraph_op_AvgPool(py::module m) {
    ...
    py::class_<ngraph::op::AvgPool, std::shared_ptr<ngraph::op::AvgPool>, ngraph::op::RequiresTensorViewArgs> avg_pool(m, "AvgPool");
...
void regclass_pyngraph_op_AvgPoolBackprop(py::module m) {
    ...
    py::class_<ngraph::op::AvgPoolBackprop, std::shared_ptr<ngraph::op::AvgPoolBackprop>, ngraph::op::RequiresTensorViewArgs> avg_pool_backprop(m, "AvgPoolBackprop");
