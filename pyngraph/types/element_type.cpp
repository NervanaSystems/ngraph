...
{
    py::class_<ngraph::element::Bool, std::shared_ptr<ngraph::element::Bool>, ngraph::element::Type> tbool(m, "Bool");
    tbool.def_static("element_type", &ngraph::element::Bool::element_type,
                     py::return_value_policy::reference);
}
void regclass_pyngraph_Float32(py::module m)
{
    py::class_<ngraph::element::Float32, std::shared_ptr<ngraph::element::Float32>, ngraph::element::Type> tfloat32(m, "Float32");
    tfloat32.def_static("element_type", &ngraph::element::Float32::element_type,
                     py::return_value_policy::reference);
}
void regclass_pyngraph_Float64(py::module m)
{
    py::class_<ngraph::element::Float64, std::shared_ptr<ngraph::element::Float64>, ngraph::element::Type> tfloat64(m, "Float64");
    tfloat64.def_static("element_type", &ngraph::element::Float64::element_type,
                     py::return_value_policy::reference);
}
void regclass_pyngraph_Int8(py::module m)
{
    py::class_<ngraph::element::Int8, std::shared_ptr<ngraph::element::Int8>, ngraph::element::Type> tint8(m, "Int8");
...
{
    py::class_<ngraph::element::Int16, std::shared_ptr<ngraph::element::Int16>, ngraph::element::Type> tint16(m, "Int16");
...
{
    py::class_<ngraph::element::Int32, std::shared_ptr<ngraph::element::Int32>, ngraph::element::Type> tint32(m, "Int32");
    tint32.def_static("element_type", &ngraph::element::Int32::element_type,
                     py::return_value_policy::reference);
}
void regclass_pyngraph_Int64(py::module m)
{
    py::class_<ngraph::element::Int64, std::shared_ptr<ngraph::element::Int64>, ngraph::element::Type> tint64(m, "Int64");
    tint64.def_static("element_type", &ngraph::element::Int64::element_type,
                     py::return_value_policy::reference);
}
void regclass_pyngraph_UInt8(py::module m)
{
    py::class_<ngraph::element::UInt8, std::shared_ptr<ngraph::element::UInt8>, ngraph::element::Type> tuint8(m, "UInt8");
...
{
    py::class_<ngraph::element::UInt16, std::shared_ptr<ngraph::element::UInt16, ngraph::element::Type> tuint16(m, "UInt16");
...
{
    py::class_<ngraph::element::UInt32, std::shared_ptr<ngraph::element::UInt32>, ngraph::element::Type> tuint32(m, "UInt32");
    tuint32.def_static("element_type", &ngraph::element::UInt32::element_type,
                     py::return_value_policy::reference);
}
void regclass_pyngraph_UInt64(py::module m)
{
    py::class_<ngraph::element::UInt64, std::shared_ptr<ngraph::element::UInt64>, ngraph::element::Type> tuint64(m, "UInt64");
