...
{
    py::class_<ngraph::element::Bool, std::shared_ptr<ngraph::element::Bool>> tbool(m, "Bool");
    tbool.def_static("element_type", &ngraph::element::Bool::element_type,
                     py::return_value_policy::reference);
}
void regclass_pyngraph_Float32(py::module m)
{
    py::class_<ngraph::element::Float32, std::shared_ptr<ngraph::element::Float32>> tfloat32(m, "Float32");
    tfloat32.def_static("element_type", &ngraph::element::Float32::element_type,
                     py::return_value_policy::reference);
}
void regclass_pyngraph_Float64(py::module m)
{
    py::class_<ngraph::element::Float64, std::shared_ptr<ngraph::element::Float64>> tfloat64(m, "Float64");
    tfloat64.def_static("element_type", &ngraph::element::Float64::element_type,
                     py::return_value_policy::reference);
}
void regclass_pyngraph_Int8(py::module m)
{
    py::class_<ngraph::element::Int8, std::shared_ptr<ngraph::element::Int8>> tint8(m, "Int8");
...
{
    py::class_<ngraph::element::Int64, std::shared_ptr<ngraph::element::Int64>> tint64(m, "Int64");
    tint64.def_static("element_type", &ngraph::element::Int64::element_type,
                     py::return_value_policy::reference);
}
void regclass_pyngraph_UInt8(py::module m)
{
    py::class_<ngraph::element::UInt8, std::shared_ptr<ngraph::element::UInt8>> tuint8(m, "UInt8");
...
{
    py::class_<ngraph::element::UInt64, std::shared_ptr<ngraph::element::UInt64>> tuint64(m, "UInt64");
