...
############################################
Fine-tune code deployment on nGraph devices  
############################################
...
*environment variables* used to tune for optimal performance when your system 
already has a version of nGraph installed and available to the framework.  
