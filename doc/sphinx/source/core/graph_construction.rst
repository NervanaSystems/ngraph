...
.. toctree::
   ...
   constructing-graphs/execute.rst
   constructing-graphs/operator.rst
   constructing-graphs/update.rst
   constructing-graphs/derive-for-training.rst
   constructing-graphs/distribute-train.rst
   constructing-graphs/import.rst
...
if an entity (framework or user) wishes to make use of target-based
...
computation that can run on an nGraph backend; this is analogous to a framework
bridge. We also provide a larger example for training and evaluating a simple
MNIST MLP model.
