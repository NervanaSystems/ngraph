...
We need to include <ngraph/distributed.hpp> and declare an object of type Distributed
to automatically initialize and finalize MPI; see the `full raw code`_.
