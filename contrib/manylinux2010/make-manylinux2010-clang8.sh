...
docker build  --rm=true \
       ...
       -f="${SCRIPT_DIR}/docker/Dockerfile.ngraph.manylinux2010_clang8" \
       -t="ngraph:manylinux2010_clang8" \
       ${SCRIPT_DIR}
...
docker run -it -u`id -u`:`id -g` \
       ...
       ngraph:manylinux2010_clang8 \
       ${SCRIPT_DIR}/helper/build-manylinux2010-clang.sh
