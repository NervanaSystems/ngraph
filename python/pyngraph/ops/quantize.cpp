...
{
    py::class_<ngraph::op::Quantize, std::shared_ptr<ngraph::op::Quantize>, ngraph::op::Op> quantize(m, "Quantize");
    quantize.doc() = "ngraph.impl.op.Quantize wraps ngraph::op::Quantize";
    py::enum_<ngraph::op::Quantize::RoundMode>(quantize, "RoundMode")
        .value("ROUND_NEAREST_TOWARD_INFINITY", ngraph::op::Quantize::RoundMode::ROUND_NEAREST_TOWARD_INFINITY)
        .value("ROUND_NEAREST_TOWARD_ZERO", ngraph::op::Quantize::RoundMode::ROUND_NEAREST_TOWARD_ZERO)
        ...
        .value("ROUND_NEAREST_TOWARD_EVEN", ngraph::op::Quantize::RoundMode::ROUND_NEAREST_TOWARD_EVEN)
