...
void regclass_pyngraph_op_ParameterVector(py::module m) {
    ...
    py::class_<ngraph::op::ParameterVector, std::shared_ptr<ngraph::op::ParameterVector>> parameter_vector(m, "ngraph.op.ParameterVector wraps ngraph::op::ParameterVector");
