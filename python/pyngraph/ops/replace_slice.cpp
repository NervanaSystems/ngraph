...
void regclass_pyngraph_op_ReplaceSlice(py::module m) {
    ...
    py::class_<ngraph::op::ReplaceSlice, std::shared_ptr<ngraph::op::ReplaceSlice>, ngraph::op::util::RequiresTensorViewArgs> replace_slice(m, "ngraph.op.ReplaceSlice wraps ngraph::op::ReplaceSlice");
