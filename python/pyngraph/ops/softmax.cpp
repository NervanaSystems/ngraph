...
void regclass_pyngraph_op_Softmax(py::module m){
    ...
    py::class_<ngraph::op::Softmax, std::shared_ptr<ngraph::op::Softmax>, ngraph::op::util::UnaryElementwiseArithmetic> softmax(m, "ngraph.op.Softmax wraps ngraph::op::Softmax");
