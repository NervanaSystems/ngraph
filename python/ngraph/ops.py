...
from ngraph.impl.op import Abs, Acos, Add, And, Asin, ArgMax, ArgMin, Atan, AvgPool, \
    ...
    Gelu, Gemm, GetOutputElement, Greater, GreaterEq, GRN, HardSigmoid, Less, LessEq, Log, LRN, \
    Max, Maximum, MaxPool, Min, Minimum, Multiply, MVN, Negative, Not, NotEqual, OneHot, Or, Pad, \
    Parameter, PRelu, Product, Power, Relu, ReplaceSlice, Reshape, Reverse, ScaleShift, Select, \
    Sign, Sin, Sinh, Slice, Softmax, SpaceToDepth, Sqrt, Subtract, Sum, Tan, Tanh, TopK
