...
void regclass_pyngraph_op_Constant(py::module m)
{
    ...
    constant.def(py::init<ngraph::element::Type, const ngraph::Shape&, const std::vector<char>&>());
    constant.def(
        py::init<ngraph::element::Type, const ngraph::Shape&, const std::vector<float>&>());
    constant.def(
        py::init<ngraph::element::Type, const ngraph::Shape&, const std::vector<double>&>());
    constant.def(
        py::init<ngraph::element::Type, const ngraph::Shape&, const std::vector<int8_t>&>());
    constant.def(
        py::init<ngraph::element::Type, const ngraph::Shape&, const std::vector<int16_t>&>());
    constant.def(
        py::init<ngraph::element::Type, const ngraph::Shape&, const std::vector<int32_t>&>());
    constant.def(
        py::init<ngraph::element::Type, const ngraph::Shape&, const std::vector<int64_t>&>());
    constant.def(
        py::init<ngraph::element::Type, const ngraph::Shape&, const std::vector<uint8_t>&>());
    constant.def(
        py::init<ngraph::element::Type, const ngraph::Shape&, const std::vector<uint16_t>&>());
    constant.def(
        py::init<ngraph::element::Type, const ngraph::Shape&, const std::vector<uint32_t>&>());
    constant.def(
        py::init<ngraph::element::Type, const ngraph::Shape&, const std::vector<uint64_t>&>());
