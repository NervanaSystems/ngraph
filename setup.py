...
ext_modules = [Extension('wrapper.ngraph.types.clsTraitedType',
               ...
               Extension('wrapper.ngraph.clsNode',
               ...
               Extension('wrapper.ngraph.ops.clsOp',
                        ['wrapper/ngraph/ops/op.cpp'], include_dirs),
               Extension('wrapper.ngraph.ops.clsAdd',
                        ['wrapper/ngraph/ops/add.cpp'], include_dirs),
               Extension('wrapper.ngraph.ops.clsDot',
                        ['wrapper/ngraph/ops/dot.cpp'], include_dirs),
               Extension('wrapper.ngraph.ops.clsMaximum',
                        ['wrapper/ngraph/ops/maximum.cpp'], include_dirs),
               Extension('wrapper.ngraph.ops.clsDivide',
                        ['wrapper/ngraph/ops/divide.cpp'], include_dirs),
               Extension('wrapper.ngraph.ops.clsMinimum',
                        ['wrapper/ngraph/ops/minimum.cpp'], include_dirs),
               Extension('wrapper.ngraph.ops.clsExp',
                        ['wrapper/ngraph/ops/exp.cpp'], include_dirs),
               Extension('wrapper.ngraph.ops.clsSubtract',
                        ['wrapper/ngraph/ops/subtract.cpp'], include_dirs),
               Extension('wrapper.ngraph.ops.clsReshape',
                        ['wrapper/ngraph/ops/reshape.cpp'], include_dirs),
               Extension('wrapper.ngraph.ops.clsBroadcast',
                        ['wrapper/ngraph/ops/broadcast.cpp'], include_dirs),
               Extension('wrapper.ngraph.ops.clsReduce',
                        ['wrapper/ngraph/ops/reduce.cpp'], include_dirs),
               Extension('wrapper.ngraph.ops.clsParameterizedConstant',
                        ['wrapper/ngraph/ops/constant.cpp'], include_dirs),
               Extension('wrapper.ngraph.runtime.clsUtils',
