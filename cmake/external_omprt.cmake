...
add_custom_command(TARGET ext_omprt POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy ${OMPRT_INSTALL_PREFIX}/${CMAKE_INSTALL_LIBDIR}/libomp.so ${NGRAPH_BUILD_DIR}
    COMMAND ${CMAKE_COMMAND} -E copy ${OMPRT_INSTALL_PREFIX}/${CMAKE_INSTALL_LIBDIR}/libgomp.so ${NGRAPH_BUILD_DIR}
    COMMAND ${CMAKE_COMMAND} -E copy ${OMPRT_INSTALL_PREFIX}/${CMAKE_INSTALL_LIBDIR}/libiomp5.so ${NGRAPH_BUILD_DIR}
