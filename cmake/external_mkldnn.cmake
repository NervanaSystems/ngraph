...
if(MKLDNN_INCLUDE_DIR AND MKLDNN_LIB_DIR)
    ...
    # This is a hack for PaddlePaddle
    if(EXISTS ${MKLDNN_LIB_DIR}/../${MKLDNN_SHORT_LIB})
        install(FILES ${MKLDNN_LIB_DIR}/../${MKLDNN_SHORT_LIB} DESTINATION ${NGRAPH_INSTALL_LIB})
    else()
        install(FILES ${MKLDNN_LIB_DIR}/${MKLDNN_LIB} DESTINATION ${NGRAPH_INSTALL_LIB})
    endif()
    install(FILES ${MKLML_LIB_DIR}/${MKLML_LIB} ${MKLML_LIB_DIR}/${OMP_LIB}  DESTINATION ${NGRAPH_INSTALL_LIB})
    return()
endif()
