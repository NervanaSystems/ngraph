...
if (${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
    ...
    set(MKL_SHA1_HASH 155fe3ed6d30a772baedb224c41c0e9c784e4b46)
    set(MKL_LIBS libiomp5.so libmklml_intel.so)
elseif (APPLE)
    set(MKLPACKAGE "mklml_mac_${MKLVERSION}.tgz")
    set(MKL_SHA1_HASH d2652cdbefbebf1096153a4154cb30ff643ec8f5)
    set(MKL_LIBS libmklml.dylib libiomp5.dylib)
elseif (WIN32)
    set(MKLPACKAGE "mklml_win_${MKLVERSION}.zip")
    set(MKL_SHA1_HASH aefbe989a64cafe9a5b183e78defb4895f14900c)
...
set(MKLDNN_GIT_TAG "fa5f6313d6b65e8f6444c6900432fb07ef5661e5")
