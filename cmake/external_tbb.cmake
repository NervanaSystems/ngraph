...
if(NGRAPH_TBB_ENABLE)
    ...
    message(WARNING "TBB_BUILD_DIR ${TBB_BUILD_DIR}")
    message(WARNING "TBB_LIB ${TBB_LIB}")
    message(WARNING "NGRAPH_LIBRARY_OUTPUT_DIRECTORY ${NGRAPH_LIBRARY_OUTPUT_DIRECTORY}")

    message(WARNING "NGRAPH_LIBRARY_INSTALL_SRC_DIRECTORY ${NGRAPH_LIBRARY_INSTALL_SRC_DIRECTORY}")
    message(WARNING "NGRAPH_INSTALL_LIB ${NGRAPH_INSTALL_LIB}")

    file(COPY ${TBB_BUILD_DIR}/${TBB_LIB} DESTINATION ${NGRAPH_LIBRARY_OUTPUT_DIRECTORY})
    if(LINUX)
        ...
        file(COPY ${TBB_BUILD_DIR}/${TBB_LIB}.${TBB_SOVER} DESTINATION ${NGRAPH_LIBRARY_OUTPUT_DIRECTORY})
    endif()
